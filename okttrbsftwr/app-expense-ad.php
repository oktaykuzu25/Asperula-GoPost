...
<head>
    ...
    <title>Asperula Kafe -Gider Ekleme </title>
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Gider Ekleme </li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-12">
                            <div class="alert alert-arrow-right alert-icon-right alert-light-danger alert-dismissible fade show mb-4" role="alert">
                                ...
                                <strong>Dikkat: </strong> Gider eklerken lütfen tüm bilgileri doğru ve eksiksiz doldurduğunuzdan emin olun. Yanlış veya eksik bilgi, siparişlerin doğru şekilde alınmasını ve işlenmesini engelleyebilir. </a>
                            </div>
                        </div>
                        ...
                        <form action="app-expense-ad.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div class="widget-content widget-content-area ecommerce-create-section">
                                                ...
                                                <div class="col-sm-6">
                                                        ...
                                                        <input type="text" class="form-control" name="expense_explanation" >
                                                
                                                    </div>
                                                    <div class="col-sm-6">
                                                    <label for="product_category_id"> Gider Türü</label>
                                                    <select class="form-select" id="product_category_id" name="expense_type">
                                                    ...
                                                    <div class="col-sm-6 mt-2">
                                                                ...
                                                                <select class="form-select" id="product_category_id" name="expense_paymentype">
                                                                    ...
                                                                    ?>
                                                                            <option value="<?php echo $data['id'] ?>"><?php echo $data['payment_types_name'] ?></option>
                                                                    <?php
                                                                            $sn++;
                                                                        }
                                                                    } else {
                                                ...
                                                <div class="col-sm-12">
                                                    <button class="btn btn-primary w-100" type="submit" name="app-expense-ad">Gider Ekle</button>
                                                </div>
