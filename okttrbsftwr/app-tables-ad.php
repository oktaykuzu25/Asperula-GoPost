...
<head>
    ...
    <title>Asperula Kafe -Masa Ekleme </title>
                                            ...
                                            <div class="widget-content widget-content-area ecommerce-create-section">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" class="form-control" name="tables_number">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label for="product_name">Masa Adı </label>
                                                        <input type="text" class="form-control" name="tables_name">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-12 col-md-6 mb-4">
                                                    <label for="product_category_id"> Masa Konumu</label>
                                                    <select class="form-select" id="product_category_id" name="tables_role">
                                                ...
                                                <div class="col-sm-12">
                                                    <button class="btn btn-primary w-100" type="submit" name="app-tables-ad">Masa Ekle</button>
                                                </div>
