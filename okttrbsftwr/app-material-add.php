...
<head>
    ...
    <title>Materyal Ekle | Asperula Kafe - Sipariş Sistemi Paneli </title>
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Materyal Ekle</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-12">
                            <div class="alert alert-arrow-right alert-icon-right alert-light-danger alert-dismissible fade show mb-4" role="alert">
                                ...
                                <strong>Dikkat: </strong> Lütfen yükleme işlemi sırasında depodaki tüm materyallerin doğru etiketlendiğinden ve uygun şekilde kategorize edildiğinden emin olun. Yanlış yüklemeler envanter yönetiminde sorunlara yol açabilir. </a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Depo Yönetimi</h5>
                                    <p class="card-text">Depo yönetimi, kafe işletmenizin envanterini düzenli ve erişilebilir tutmanızı sağlayan süreçtir. Doğru bir depo yönetimi, müşteri memnuniyetini artırır ve maliyetlerinizi kontrol altında tutmanıza yardımcı olur.</p>
                                </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6  mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Materyal Yükleme Prosedürü</h5>
                                    <p class="card-text">Materyal yükleme işlemi, her ürünün doğru kategoriye eklenmesini ve eksiksiz bilgilerle sistemde yer almasını gerektirir. Bu, envanter takibini kolaylaştırır ve stok hatalarını en aza indirir. Ürünlerin barkodlarını tarayarak veya elle giriş yaparak sisteme dahil edebilirsiniz.</p>
                                </div>
                                <div class="card-footer px-4 pt-0 border-0">
                                    <a href="pages-faq.php" target="_blank">Sıkça Sorulan Sorular</a>
                                </div>
                        ...
                        <form action="app-material-add.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="widget-content widget-content-area ecommerce-create-section">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input type="number" class="form-control" id="material_unit_amount" name="material_unit_amount">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-2">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input type="text" class="form-control" id="material_price" name="material_price">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xxl-12">
                                                                <div class="switch form-switch-custom switch-inline form-switch-secondary">
                                                                    <input class="switch-input" type="checkbox" role="switch" name="material_publicy" id="material_publicy">
                                                ...
                                                <div class="col-xxl-12 col-xl-4 col-lg-4 col-md-5 mt-4">
                                                    <div class="widget-content widget-content-area ecommerce-create-section">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <button class="btn btn-primary w-100" type="submit" name="material-add">Materyal Ekle</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
