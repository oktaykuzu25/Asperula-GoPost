...
//VERITABANINDAN STOCK DETAY SAYFASINA VERI CEKME KODLARI 
if (isset($_SERVER['REQUEST_URI'])) {
    $url_segments = explode('/', $_SERVER['REQUEST_URI']);
    $stock_id = end($url_segments);
    $id = validate($stock_id);
    $fetchDataStockDetails = fetch_data_stock_detail($db, $tableNameStock, $columnsStock, $id);
    $material_id_stock = $fetchDataStockDetails['material_id'];
    $storage_id_stock = $fetchDataStockDetails['storage_id'];
    $fetchDataMaterialTableForStock = fetch_data_materialTable_for_stock($db, $tableNameMaterial, $columnsMaterial, $material_id_stock);
    $fetchDataStorageTableForStock = fetch_data_storageTable_for_stock($db, $tableNameStorage, $columnsStorage, $storage_id_stock);
}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title><?php echo $fetchDataMaterialTableForStock['material_name'] ?> Stok Düzenleme | Asperula Kafe - Sipariş Sistemi Paneli </title>
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active">
                        <a href="#stock" data-bs-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                        ...
                        <ul class="collapse submenu list-unstyled show" id="stock" data-bs-parent="#accordionExample">
                            <li class="active">
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Stok Ürün Ekle</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-12">
                            <div class="alert alert-arrow-right alert-icon-right alert-light-danger alert-dismissible fade show mb-4" role="alert">
                                ...
                                <strong>Dikkat: </strong> Stok ürünlerini düzenlerken, her ürünün güncel ve doğru bilgilerle listelendiğinden emin olun. Yanlış veya eksik bilgiler, envanter hatalarına ve operasyonel aksaklıklara yol açabilir.</a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Stok Yönetiminde Güncellemelerin Rolü</h5>
                                    <p class="card-text">Stok yönetimi, kafe işletmenizin verimliliğini ve stok doğruluğunu artırmak için düzenli güncellemeler gerektirir. Ürün bilgilerini düzenli olarak güncellemek, envanterin gerçek zamanlı takibini sağlar ve stokta bulunmama durumlarını önler.</p>
                                </div>
                                <div class="card-footer px-4 pt-0 border-0">
                                    <a href="pages-faq.php" target="_blank">Sıkça Sorulan Sorular</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6  mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Stok Ürünlerini Düzenleme</h5>
                                    <p class="card-text">Stok ürünlerini düzenlerken, ürünlerin doğru kategorilerde olduğundan ve tüm bilgilerin güncel ve eksiksiz olduğundan emin olun. Ürün adı, miktar, tedarikçi bilgileri ve barkod gibi verilerin doğruluğunu kontrol etmek, envanter yönetiminde hataları en aza indirir.</p>
                                </div>
                                <div class="card-footer px-4 pt-0 border-0">
                                    <a href="pages-faq.php" target="_blank">Sıkça Sorulan Sorular</a>
                                </div>
                        ...
                        <form action="app-stock-edit.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-4 layout-spacing layout-top-spacing">
                                        ...
                                        <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div class="widget-content widget-content-area ecommerce-create-section">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-sm-12">
                                                        <label for="stock_amount">Çıkan Stok Miktarı</label>
                                                        <input type="number" class="form-control" id="stock_amount" name="stock_amount" value="<?php echo $fetchDataStockDetails['stock_amount'] ?>">
                                                        <input type="hidden" class="form-control" id="stock_id" name="stock_id" value="<?php echo $fetchDataStockDetails['stock_id'] ?>">
                                                    </div>
                                                </div>

                                                <div class="row mb-4">
                                                    <div class="col-sm-12">
                                                        <label for="stock_price">Stok Fiyatı</label>
                                                        <input type="text" class="form-control" id="stock_price" name="stock_price" value="<?php echo $fetchDataStockDetails['stock_price'] ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-sm-12">
                                                        <div class="col-xxl-12 col-md-6 mb-4">
                                                            <label for="stock_processing">İşlem</label>
                                                            <select class="form-select" id="stock_processing" name="stock_processing">
                                                                <option value="">Seçiniz</option>
                                                                <option value="Giren Stok" <?php if ($fetchDataStockDetails['stock_processing'] == 'Giren Stok') echo 'selected'; ?>>Giren Stok</option>
                                                                <option value="Çıkan Stok" <?php if ($fetchDataStockDetails['stock_processing'] == 'Çıkan Stok') echo 'selected'; ?>>Çıkan Stok</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xxl-12 mb-4">
                                                                <div class="switch form-switch-custom switch-inline form-switch-secondary">
                                                                    <input class="switch-input" type="checkbox" role="switch" name="stock_publicy" id="stock_publicy" <?php echo ($fetchDataStockDetails['stock_publicy'] == '1') ? 'checked' : ''; ?>>
                                                                    <label class="switch-label" for="stock_publicy">Stok Durumu</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-xxl-12 col-md-6 mb-4">
                                                                <label for="storage_id">Ürün Deposu</label>
                                                                <select class="form-select" id="storage_id" name="storage_id">
                                                                    <option value="">Seçiniz</option>
                                                                    <?php
                                                                    if (is_array($fetchDataStorageForStock)) {
                                                                        foreach ($fetchDataStorageForStock as $data) {
                                                                            $selected = ($data['storage_id'] == $fetchDataStorageTableForStock['storage_id']) ? 'selected' : '';
                                                                    ?>
                                                                            <option value="<?php echo $data['storage_id'] ?>" <?php echo $selected ?>><?php echo $data['storage_name'] ?></option>
                                                                    <?php
                                                                        }
                                                                    } else {
                                                                        echo $fetchDataStorageForStock;
                                                                    } ?>
                                                                </select>
                                                            </div>

                                                            <div class="col-xxl-12 col-md-6 mb-4">
                                                                <label for="material_id">Materyal</label>
                                                                <select class="form-select" id="material_id" name="material_id">
                                                                    <option value="">Seçiniz</option>


                                                                    <?php
                                                                    if (is_array($fetchDataMaterialForStock)) {
                                                                        foreach ($fetchDataMaterialForStock as $data) {
                                                                            $selected = ($data['material_id'] == $fetchDataMaterialTableForStock['material_id']) ? 'selected' : '';
                                                                    ?>
                                                                            <option value="<?php echo $data['material_id'] ?>" <?php echo $selected ?>><?php echo $data['material_name'] ?></option>
                                                                    <?php
                                                                        }
                                                                    } else {
                                                                        echo $fetchDataMaterialForStock;
                                                                    } ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-xxl-12 col-xl-4 col-lg-4 col-md-5 mt-4">
                                                    <div class="widget-content widget-content-area ecommerce-create-section">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <button class="btn btn-primary w-100" type="submit" name="stock-update">Materyal Düzenle</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
