...
<head>
    ...
    <title>Depo | Asperula Kafe - Sipariş Sistemi Paneli </title>
...
<body class="layout-boxed">
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="app-storage.php">Depo</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Depolar</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                    ...
                    <div class="row layout-top-spacing">
                            ...
                            <div class="widget-content widget-content-area br-8">
                                <table id="zero-config" class="table table-striped dt-table-hover" style="width:100%">
                                    <div class="col-md-12 col-sm-12 col-12 m-2">
                                        <a class="btn btn-primary" id="addTask" href="#" data-toggle="modal" data-target="#addTaskModal">
                                    ...
                                    <tbody>
                                        <?php
                                        if (is_array($fetchDataStorage)) {
                                            $sn = 1;
                                            foreach ($fetchDataStorage as $data) {
                                                $storage_name_url = $data['storage_name'];
                                                $storage_id_url = $data['storage_id'];

                                                $seo_name = cleanTurkishCharacters($storage_name_url);

                                                // SEO uyumlu URL'yi oluştur
                                                $url = "/$seo_name" . "/$storage_id_url";
                                        ?>
                                                <tr>
                                                    <td><?php echo $data['storage_name'] ?></td>
                                                    <td><?php echo $data['storage_code'] ?></td>
                                                    <td><?php echo $data['storage_currentDateTime'] ?></td>
                                                    <td>

                                                        <a href="app-storage-edit.php?<?php echo $url ?>">
                                                            <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                                <g id="SVGRepo_iconCarrier">
                                                        ...
                                                        <a href="app-storage.php?deleteStorage=<?php echo $data['storage_id']; ?>">
                        ...
                        <div class="modal fade" id="addTaskModal" tabindex="-1" role="dialog" aria-labelledby="addTaskModalTitle" aria-hidden="true" data-backdrop="false">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title add-title" id="addTaskModalTitleLabel1">Depo</h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="compose-box">
                                            <div class="compose-content" id="addTaskModalTitle">
                                                <form action="app-storage.php" method="POST">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="d-flex mail-to mb-4">
                                                                <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    ...
                                                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                                    <g id="SVGRepo_iconCarrier">
                                                                        <path d="M5 9V5C5 3.89543 5.89543 3 7 3H17C18.1046 3 19 3.89543 19 5V9M5 9H19M5 9V15M19 9V15M19 15V19C19 20.1046 18.1046 21 17 21H7C5.89543 21 5 20.1046 5 19V15M19 15H5M8 12H8.01M8 6H8.01M8 18H8.01" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                                                    </g>
                                                                </svg>
                                                                <div class="w-100">
                                                                    <input id="task" type="text" placeholder="Depo Adı" class="form-control" name="storage_name">
                                                                </div>
                                                            </div>
                                                            <div class="d-flex mail-to mb-4">
                                                                <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                ...
                                                                <div class="w-100">
                                                                    <input id="task" type="text" placeholder="Depo Kodu" class="form-control" name="storage_code">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <button class="btn add-tsk btn-primary" name="storage-add" type="submit">Depo Ekle</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        <button class="btn btn-" data-bs-dismiss="modal"><i class="flaticon-cancel-12"></i> Kapat</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script src="../src/assets/js/apps/storage.js"></script>
