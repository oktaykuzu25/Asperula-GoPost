...
<head>
    ...
    <title>Kategori Listesi | Asperula Kafe - Sipariş Sistemi Paneli </title>
...
<body class="layout-boxed">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="inv-amount">
                                                            <?php
                                                            $description = $data['product_category_description'];
                                                            echo strlen($description) > 40 ? substr($description, 0, 60) . '...' : $description;
                                                            ?>
                                                        </span>
                                                    </td>
                                                    <td><span class="inv-date"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar">
                                                            ...
                                                            </svg> <?php echo $data['product_category_currentDateTime'] ?> </span></td>
                                                    <td><?php
                                                        if (isset($data['product_category_publicy'])) {
                                                            if ($data['product_category_publicy'] == 1) {
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="badge badge-light-danger text-start action-delete" href="app-product-category.php?deleteProductCategory=<?php echo $data['product_category_id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash">
    ...
    <script src="../src/assets/js/apps/category-list.js"></script>
