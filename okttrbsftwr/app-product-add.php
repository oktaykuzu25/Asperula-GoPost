...
<head>
    ...
    <title>Ürün Ekle | Asperula Kafe - Sipariş Sistemi Paneli </title>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    ...
                                    <p class="card-text">Ürün adının net ve açıklayıcı olmasına dikkat edin. Müşterilerin ürünü kolayca tanıyabilmesi için isimde spesifik detaylar yer almalıdır.</p>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6  mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    ...
                                    <p class="card-text">Ürünün fiyatını doğru girin ve tüm vergilerin dahil olduğundan emin olun. Fiyatlandırma hataları müşteri memnuniyetsizliğine yol açabilir.</p>
                                </div>
                                <div class="card-footer px-4 pt-0 border-0">
                                    <a href="pages-faq.php" target="_blank">Sıkça Sorulan Sorular</a>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6  mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    ...
                                    <p class="card-text">Ürünün içeriği, malzemeleri ve varsa alerjen bilgilerini detaylı bir şekilde açıklayın. Bu, müşterilerin doğru ürünü seçmesine yardımcı olur ve alerjik reaksiyonları önler.</p>
                                </div>
                                <div class="card-footer px-4 pt-0 border-0">
                                    <a href="pages-faq.php" target="_blank">Sıkça Sorulan Sorular</a>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6  mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    ...
                                    <p class="card-text">Ürünün yüksek kaliteli ve çekici bir fotoğrafını yükleyin. Görseller müşterilerin ilgisini çeker ve satın alma kararını olumlu yönde etkiler.</p>
                                </div>
                                <div class="card-footer px-4 pt-0 border-0">
                                    <a href="pages-faq.php" target="_blank">Sıkça Sorulan Sorular</a>
                                </div>
                                            ...
                                            <div class="widget-content widget-content-area ecommerce-create-section">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <textarea name="product_info" class="form-control" id="product_info" cols="30" rows="5"></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-2">
                                                    <div class="col-sm-3 mb-4">
                                                        ...
                                                        <input type="text" class="form-control" id="product_small_price" name="product_small_price">
                                                    </div>
                                                    <div class="col-sm-3 mb-4">
                                                        <label for="product_middle_price">Orta Boy Ürün Fiyatı</label>
                                                        <input type="text" class="form-control" id="product_middle_price" name="product_middle_price">
                                                    </div>
                                                    <div class="col-sm-3 mb-4">
                                                        <label for="product_big_price">Büyük Boy Ürün Fiyatı</label>
                                                        <input type="text" class="form-control" id="product_big_price" name="product_big_price">
                                                    </div>
                                                    <div class="col-sm-3">
                                            ...
                                            <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xxl-12 mb-4">
                                                                <div class="switch form-switch-custom switch-inline form-switch-secondary">
                                                                    <input class="switch-input" type="checkbox" role="switch" name="product_publicy" id="product_publicy">
                                                ...
                                                <div class="col-xxl-12 col-xl-4 col-lg-4 col-md-5 mt-4">
                                                    <div class="widget-content widget-content-area ecommerce-create-section">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <button class="btn btn-primary w-100" type="submit" name="product-add">Ürün Ekle</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
