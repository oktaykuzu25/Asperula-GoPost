...
<body class="layout-boxed">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active">
                        <a href="./app-businesses.php" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">İşletme Güncelleme</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-12">
                            <div class="alert alert-arrow-right alert-icon-right alert-light-danger alert-dismissible fade show mb-4" role="alert">
                                ...
                                <strong>Dikkat: </strong> Ürün eklerken lütfen tüm bilgileri doğru ve eksiksiz doldurduğunuzdan emin olun. Yanlış veya eksik bilgi, siparişlerin doğru şekilde alınmasını ve işlenmesini engelleyebilir. </a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Kullanıcı Dostu Arayüz</h5>
                                    <p class="card-text">Kullanıcıların işletme hesaplarını kolayca ekleyebilmeleri için arayüzün sade ve anlaşılır olması önemlidir. Gereksiz bilgi veya karmaşıklık yaratacak unsurlardan kaçınılmalı, form alanları net bir şekilde belirtilmelidir.</p>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6  mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Güvenlik Önlemleri</h5>
                                    <p class="card-text"> Hesap bilgileri girilirken kullanıcıların güvenliğini sağlamak için SSL sertifikaları ve
                                        güvenli bağlantı protokolleri kullanılmalıdır. Ayrıca, şifrelerin güçlü olması ve gerektiğinde iki
                                        faktörlü kimlik doğrulama sunulmalıdır.</p>
                                </div>
                                <div class="card-footer px-4 pt-0 border-0">
                                    <a href="pages-faq.php" target="_blank">Sıkça Sorulan Sorular</a>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6  mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Veri Doğrulama</h5>
                                    <p class="card-text">Kullanıcıların girdiği bilgilerin doğruluğunu kontrol
                                        eden mekanizmalar uygulanmalıdır. Örneğin, e-posta adreslerinin geçerliliği,
                                        telefon numaralarının formatı gibi kriterler göz önünde bulundurulmalıdır.</p>
                                </div>
                                <div class="card-footer px-4 pt-0 border-0">
                                    <a href="pages-faq.php" target="_blank">Sıkça Sorulan Sorular</a>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6  mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Uyumluluk ve Erişilebilirlik</h5>
                                    <p class="card-text"> Hesap ekleme sayfası farklı cihazlar ve tarayıcılarla uyumlu olmalı, erişilebilirlik
                                        standartlarına uygun olarak tasarlanmalıdır.
                                        Engelli kullanıcılar için de erişilebilir olmasına özen gösterilmelidir.</p>
                                </div>
                                <div class="card-footer px-4 pt-0 border-0">
                                    <a href="pages-faq.php" target="_blank">Sıkça Sorulan Sorular</a>
                                </div>
                                    ...
                                    <div class="row mb-4 layout-spacing layout-top-spacing">
                                        ...
                                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div class="widget-content widget-content-area ecommerce-create-section">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-sm-6">
                                                        <label for="product_name">İşletme Adı</label>
                                                        <input type="text" class="form-control" name="product_business" value="<?php echo $fetchDataAppBusinessUpdate['business_name']; ?>">
                                                        <input type="hidden" class="form-control" name="business_id" value="<?php echo $fetchDataAppBusinessUpdate['business_id'] ?>">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label for="product_name">Ülke</label>
                                                        <input type="text" class="form-control" name="product_country" value="<?php echo $fetchDataAppBusinessUpdate['business_country']; ?>">
                                                    </div>
                                                </div>

                                                <div class="row mb-4">
                                                    <div class="col-sm-6">
                                                        <label for="product_name">Şehir</label>
                                                        <input type="text" class="form-control" name="product_city" value="<?php echo $fetchDataAppBusinessUpdate['business_city']; ?>">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label for="product_name">İl</label>
                                                        <input type="text" class="form-control" name="product_province" value="<?php echo $fetchDataAppBusinessUpdate['business_province']; ?>">
                                                    </div>
                                                </div>

                                                <div class="row mb-4">
                                                    <div class="col-sm-6">
                                                        <label for="product_name">İlçe</label>
                                                        <input type="text" class="form-control" name="product_district" value="<?php echo $fetchDataAppBusinessUpdate['business_district']; ?>">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label for="product_name">Adres</label>
                                                        <input type="text" class="form-control" name="product_address" value="<?php echo $fetchDataAppBusinessUpdate['business_address']; ?>">
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col-sm-6">
                                                        <label for="product_name">Telefon Numarası</label>
                                                        <input type="text" class="form-control" name="product_telephone" value="<?php echo $fetchDataAppBusinessUpdate['business_telephone']; ?>">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label for="product_name">Özelliği</label>
                                                        <input type="text" class="form-control" name="product_tip" value="<?php echo $fetchDataAppBusinessUpdate['business_tip']; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <button class="btn btn-primary w-100" type="submit" name="App-ad-business-update">İşletme Güncelle</button>
                                                </div>
    ...
    <script src="../src/assets/js/apps/app-businesses-ad.js"></script>
