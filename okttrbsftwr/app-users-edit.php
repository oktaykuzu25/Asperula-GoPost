...
<head>
    ...
    <title>Kullanıcılar Düzenleme | Asperula Kafe - Sipariş Sistemi Paneli </title>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="stock" data-bs-parent="#accordionExample">
                            ...
                            <li>
                                <a href="./app-stock-movements.php"> Stok Hareketleri </a>
                            </li>
                            <li>
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Kullanıcı Güncelleme</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                                    ...
                                    <div class="row mb-4 layout-spacing layout-top-spacing">
                                        ...
                                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div class="widget-content widget-content-area ecommerce-create-section">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-sm-6">
                                                        <label for="product_name">Kullanıcı Adı</label>
                                                        <input type="text" class="form-control" name="users_name" value="<?php echo $fetchDataAppUsersUpdate['users_name']; ?> ">
                                                        <input type="hidden" class="form-control" name="users_id" value="<?php echo $fetchDataAppUsersUpdate['users_id']; ?> ">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label for="product_name">İşletme Adı</label>
                                                        <input type="text" class="form-control" name="business_name" value="<?php echo $fetchDataAppUsersUpdate['business_name']; ?> ">
                                                    </div>
                                                </div>

                                                <div class="row mb-4">
                                                    <div class="col-sm-6">
                                                        <label for="product_name">Kullanıcı Şifre</label>
                                                        <input type="text" class="form-control" name="users_psw" value="<?php echo $fetchDataAppUsersUpdate['users_psw']; ?> ">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label for="product_name">Yetkisi</label>
                                                        <input type="text" class="form-control" name="users_role" value="<?php echo $fetchDataAppUsersUpdate['users_role']; ?> ">
                                                    </div>
                                                </div>

                                                <div class="row mb-4">
                                                    <div class="col-sm-6">
                                                        <label for="product_name">Kayıt Tarihi </label>
                                                        <input type="text" class="form-control" name="users_currentDateTime" value="<?php echo $fetchDataAppUsersUpdate['users_currentDateTime']; ?> ">
                                                    </div>

                                                </div>

                                                <div class="col-sm-12">
                                                    <button class="btn btn-primary w-100" type="submit" name="App-users-update">Kullanıcı Güncelle</button>
                                                </div>
