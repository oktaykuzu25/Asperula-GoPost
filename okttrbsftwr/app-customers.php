...
<head>
    ...
    <title>Müşteriler | Asperula Kafe - Sipariş Sistemi Paneli </title>
                            ...
                            <div class="widget-content widget-content-area br-8">
                                <table id="zero-config" class="table table-striped dt-table-hover" style="width:100%">
                                    <div class="col-md-12 col-sm-12 col-12 m-2">
                                        <a class="btn btn-primary" href="app-customers-add.php">
                                    ...
                                    <tbody>
                                        <?php
                                        if (is_array($fetchDataCustomers)) {
                                            $sn = 1;
                                            foreach ($fetchDataCustomers as $data) {

                                                $customers_name_url = $data['customers_name'];
                                                $customers_id_url = $data['customers_id'];

                                                $seo_name_customers = cleanTurkishCharacters($customers_name_url);

                                                // SEO uyumlu URL'yi oluştur
                                                $url = "/$seo_name_customers" . "/$customers_id_url";
                                        ?>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">
                                                            <p class="align-self-center mb-0 admin-name"> <?php echo ($data['customers_name'] . " " . $data['customers_surname']) ?> </p>
                                                        </div>
                                                    </td>
                                                    <td><a class="text-primary" href="tel:<?php echo cleanPhoneNumber($data['customers_phone']) ?>"><?php echo $data['customers_phone'] ?></a></td>
                                                    <td><a class="text-primary" href="mailto:<?php echo $data['customers_email'] ?>"><?php echo $data['customers_email'] ?></a></td>
                                                    <td><?php echo $data['customers_address'] ?></td>
                                                    <td> <?php echo $data['customers_note'] ?></td>
                                                    <td><?php
                                                        if (isset($data['customers_publicy'])) {
                                                            if ($data['customers_publicy'] == 1) {
                                                        ...
                                                        ?></td>
                                                    <td> <?php echo $data['customers_currentDateTime'] ?> </td>
                                                    <td>
                                                        <a href="app-customers-edit.php?<?php echo $url ?>">
                                                            <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                                <g id="SVGRepo_iconCarrier">
                                                        ...
                                                        <a href="app-customers.php?deleteCustomers=<?php echo $data['customers_id']; ?>">
