...
<head>
    ...
    <title><?php echo $fetchDataMaterialDetails['material_name'] ?> Düzenleme | Asperula Kafe - Sipariş Sistemi Paneli </title>
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Materyal Düzenle</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-12">
                            <div class="alert alert-arrow-right alert-icon-right alert-light-danger alert-dismissible fade show mb-4" role="alert">
                                ...
                                <strong>Dikkat: </strong> Materyal düzenleme işlemleri sırasında her bir öğenin doğru bilgilerine sahip olduğundan emin olun. Yanlış düzenlemeler, envanter doğruluğunu etkileyebilir ve operasyonel aksamalara yol açabilir. </a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Envanter Yönetimi</h5>
                                    <p class="card-text">Envanter yönetimi, kafe işletmenizin operasyonel verimliliği ve müşteri memnuniyeti açısından kritik bir rol oynar. Düzenli ve doğru yönetilen envanter, malzeme tedarik zincirini kesintisiz ve sorunsuz hale getirir.</p>
                                </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6  mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Materyal Düzenleme Adımları</h5>
                                    <p class="card-text">Materyal düzenlerken, her ürünün uygun kategoriye yerleştirildiğinden ve tüm gerekli bilgilerin güncellendiğinden emin olun. Ürün bilgilerini güncel tutmak, stok takibini kolaylaştırır ve yanlışlıkları en aza indirir.</p>
                                </div>
                                <div class="card-footer px-4 pt-0 border-0">
                                    <a href="pages-faq.php" target="_blank">Sıkça Sorulan Sorular</a>
                                </div>
                        ...
                        <form action="app-material-edit.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-4 layout-spacing layout-top-spacing">
                                        ...
                                        <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div class="widget-content widget-content-area ecommerce-create-section">
                                                <div class="row mb-4">
                                                    <div class="col-sm-12">
                                                        <label for="product_name">Materyal Adı</label>
                                                        <input type="text" class="form-control" id="material_name" name="material_name" value="<?php echo $fetchDataMaterialDetails['material_name'] ?>">
                                                        <input type="hidden" class="form-control" id="material_id" name="material_id" value="<?php echo $fetchDataMaterialDetails['material_id'] ?>">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-sm-12">
                                                        <label for="material_unit">Materyal Birimi</label>
                                                        <select class="form-select" id="material_unit" name="material_unit">
                                                            <option value="">Seçiniz</option>
                                                            <option value="KG" <?php if ($fetchDataMaterialDetails['material_unit'] == 'KG') echo 'selected'; ?>>KG</option>
                                                            <option value="GR" <?php if ($fetchDataMaterialDetails['material_unit'] == 'GR') echo 'selected'; ?>>GR</option>
                                                            <option value="LT" <?php if ($fetchDataMaterialDetails['material_unit'] == 'LT') echo 'selected'; ?>>LT</option>
                                                            <option value="ML" <?php if ($fetchDataMaterialDetails['material_unit'] == 'ML') echo 'selected'; ?>>ML</option>
                                                            <option value="ADET" <?php if ($fetchDataMaterialDetails['material_unit'] == 'ADET') echo 'selected'; ?>>ADET</option>
                                                        </select>
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-sm-12">
                                                        <label for="material_unit_amount">Materyal Birim Miktarı</label>
                                                        <input type="number" class="form-control" id="material_unit_amount" name="material_unit_amount" value="<?php echo $fetchDataMaterialDetails['material_unit_amount'] ?>">
                                                    </div>
                                                </div>

                                                <div class="row mb-2">
                                                    <div class="col-sm-12">
                                                        <label for="material_price">Materyal Birim Fiyatı</label>
                                                        <input type="text" class="form-control" id="material_price" name="material_price" value="<?php echo $fetchDataMaterialDetails['material_price'] ?>">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xxl-12">
                                                                <div class="switch form-switch-custom switch-inline form-switch-secondary">
                                                                    <input class="switch-input" type="checkbox" role="switch" name="material_publicy" id="material_publicy" <?php echo ($fetchDataMaterialDetails['material_publicy'] == '1') ? 'checked' : ''; ?>>
                                                                    <label class="switch-label" for="material_publicy">Materyal Durumu</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-xxl-12 col-xl-4 col-lg-4 col-md-5 mt-4">
                                                    <div class="widget-content widget-content-area ecommerce-create-section">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <button class="btn btn-primary w-100" type="submit" name="material-update">Materyal Düzenle</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
