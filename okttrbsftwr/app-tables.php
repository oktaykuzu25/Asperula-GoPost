                        ...
                        <div class="widget widget-card-five">
                            <div class="widget-content">
                                <div class="account-box">
                                    <div class="info-box" style="display: flex; justify-content: center; align-items: center; height: 100%;">
                                        <div class="balance-info">
                                            <h6 style="text-align: center; color: black; font-weight: bold; margin: 0;">Kafenin İçindeki Masalar</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
if (is_array($fetchDataTable)) {
    $sn = 1;
    foreach ($fetchDataTable as $data) {
        ...
        if ($data['tables_role'] == 'Kafe_ici') {
            // Her 3 öğeden sonra yeni bir satır başlat
            if ($sn % 3 == 1) {
                if ($sn > 1) {
                    echo '</div>'; // Önceki satırı kapat
                }
                echo '<div class="row">'; // Yeni satır başlat
            }
?>
                    ...
                    <div class="widget-content">
                        <div class="account-box">
                            <div class="info-box text-center">
                                <div class="balance-info">
                                    <p style="margin: 0;"><?php echo $data['tables_number'] . " - " . $data['tables_name'] ?></p>
                                </div>
                            </div>
                            <div class="card-bottom-section d-flex justify-content-end mt-3">
                                <a href="javascript:void(0);" class="btn btn-primary">Gör</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="widget widget-card-five">
                            <div class="widget-content">
                                <div class="account-box">
                                    <div class="info-box" style="display: flex; justify-content: center; align-items: center; height: 100%;">
                                        <div class="balance-info">
                                            <h6 style="text-align: center; color: black; font-weight: bold; margin: 0;">Bahçenin Dışındaki Masalar</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
if (is_array($fetchDataTable)) {
    ...
    foreach ($fetchDataTable as $data) {
        ...
        $url = "/$seo_name" . "/$product_category_id_url";
        if ($data['tables_role'] == 'kafe_bahce') {
            // Her 3 öğeden sonra yeni bir satır başlat
            if ($sn % 3 == 1) {
                if ($sn > 1) {
                    echo '</div>'; // Önceki satırı kapat
