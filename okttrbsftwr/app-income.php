...
<head>
    ...
    <title>Gelir Tablosu | Asperula Kafe - Sipariş Sistemi Paneli </title>
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Hesaplar</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Gelir Tablosu</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                            <div class="widget-content widget-content-area br-8">
                                <div class="container">
                                    <form action="app-income.php" method="POST">
...
if (empty($data['day_endoftheday'])) {
    ...
    echo $data['day_endoftheday'];
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                            <div class="widget-content widget-content-area br-8">
                                <div class="container">
                                    <h1 class="text-center mt-3">Gelir Tablosu
                                    </h1>
                                    <div class="table-responsive">
                                        <table class="excel-table table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                if (is_array($fetchDataOrderItemsForİncomeTable)) {
                                                    $totalOrders = 0;

                                                    foreach ($fetchDataOrderItemsForİncomeTable as $dataOrderItems) {
                                                    ...
                                                    foreach ($fetchDataOrderItemsForİncomeTable as $dataOrderItems) {
                                                        // Gider verisini al
                                                        $totalExpense = isset($fetchDataExpenseForİncomeTable['total_expense_price']) ? $fetchDataExpenseForİncomeTable['total_expense_price'] : 0;
                                                        ...
                                                        $remainingAmount = $totalOrderPrice - $totalExpense;
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="font-weight: bold;">Toplam Adet: <?php echo $totalOrders ?></td>
                                                        <td style="font-weight: bold;">₺<?php echo number_format($totalOrderPrice, 2); ?></td>
                                                    </tr>

                                                    <tr>
                                                        <td style="font-weight: bold;" colspan="1">Gelir Miktarı</td>
                                                        <td style="font-weight: bold;">Toplam Gelir: ₺<?php echo number_format($totalOrderPrice, 2); ?></td>
                                                        <td style="font-weight: bold;">Toplam Gider: ₺<?php echo number_format($totalExpense, 2); ?></td>
                                                        <td style="font-weight: bold;">Kalan: ₺<?php echo number_format($remainingAmount, 2); ?></td>
                                                    </tr>
                                                <?php
                                                } else {
                                                    echo "<tr><td colspan='4'>Veriler bulunamadı.</td></tr>";
                                                }
                                                ?>
                                            </tbody>
                                        </table>
