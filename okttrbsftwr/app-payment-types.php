...
<head>
    ...
    <title>Ödeme Şekilleri | Asperula Kafe - Sipariş Sistemi Paneli </title>
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Ödeme Şekilleri</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                            ...
                            <div class="widget-content widget-content-area br-8">
                                <table id="zero-config" class="table table-striped dt-table-hover" style="width:100%">
                                    <div class="col-md-12 col-sm-12 col-12 m-2">
                                        <a class="btn btn-primary" href="app-payment-types-add.php">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus">
                                                <line x1="12" y1="5" x2="12" y2="19"></line>
                                                <line x1="5" y1="12" x2="19" y2="12"></line>
                                            </svg> Ödeme Şekli Ekle
                                        </a>
                                    </div>
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        if (is_array($fetchDataPaymentTypes)) {
                                            ...
                                            foreach ($fetchDataPaymentTypes as $data) {
                                                $material_name_url = $data['payment_types_name'];
                                                $material_id_url = $data['id'];
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <p class="align-self-center mb-0 admin-name"> <?php echo $data['payment_types_name'] ?> </p>
                                                        </div>
                                                    </td>
                                                    <td><?php echo $data['payment_types_currentDateTime'] ?></td>
                                                    <td><?php
                                                        if (isset($data['payment_types_publicy'])) {
                                                            if ($data['payment_types_publicy'] == 1) {
                                                        ...
                                                        ?></td>
                                                    <td>
                                                        <a href="app-payment-types-edit.php?<?php echo $url ?>">
                                                            <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                                <g id="SVGRepo_iconCarrier">
                                                        ...
                                                        <a href="app-storage.php?deletePaymentTypes=<?php echo $data['id']; ?>">
