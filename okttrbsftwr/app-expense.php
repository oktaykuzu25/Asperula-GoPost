...
<head>
    ...
    <title>Gider Tablosu | Asperula Kafe - Sipariş Sistemi Paneli </title>
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12 layout-top-spacing layout-spacing">
                            <div class="widget-content widget-content-area br-8">
                                <table id="invoice-list" class="table dt-table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                        if (is_array($fetchDataExpense)) {
                                            $sn = 1;
                                            foreach ($fetchDataExpense as $data) {

                                                $product_category_name_url = $data['expense_explanation'];
                                                $product_category_id_url = $data['expense_id'];

                                                $expensePaymentType = $data['expense_paymentype'];

                                                $fetchDataExpensePaymentDetail = fetch_data_expense_payment_detail($db, $tableNamePaymentTypes, $columnsPaymentTypes, $expensePaymentType);
...
<tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <p class="align-self-center mb-0 user-name"> <?php echo $data['expense_type'] ?> </p>
                                                        </div>
                                                    </td>
                                                    <td><span class="inv-amount"><?php echo $fetchDataExpensePaymentDetail['payment_types_name'] ?></span></td>
                                                    <td><span class="inv-amount"><?php echo $data['expense_explanation'] ?></span></td>
                                                    <td><span class="inv-amount"><?php echo $data['expense_amount'] ?></span></td>
                                                    <td><span class="inv-amount"><?php echo $data['expense_currentdatetime'] ?></span></td>
                                                 
                                                    <td>
                                                        <a class="badge badge-light-primary text-start me-2 action-edit" href="app-expense-edit.php?<?php echo $url ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3">
                                                                <path d="M12 20h9"></path>
                                                                <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path>
                                                            </svg></a>
                                                        <a class="badge badge-light-danger text-start action-delete" href="app-expense.php?deleteExpenseId=<?php echo $data['expense_id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash">
    ...
    <script src="../src/assets/js/apps/app-expense.js"></script>
