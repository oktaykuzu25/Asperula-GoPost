...
<head>
    ...
    <title>Menü | Asperula Kafe - Sipariş Sistemi Paneli </title>
    ...
    <style>
        ...
        .layout-spacing .section {
            height: 100%;
            /* veya istediğiniz sabit bir değer */
        }
    </style>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <ul class="nav nav-pills" id="animateLine" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="animated-all-tab" data-bs-toggle="tab" href="#animated-all" role="tab" aria-controls="animated-all" aria-selected="true">
                                                Hepsi</button>
                                        </li>
                                        <?php
                                    ...
                                    <div class="row">
                                        ...
                                        ?>
                                                <div class="col-xl-3 col-lg-12 col-md-12 layout-spacing">
                                                    <div class="section general-info border app-menu-product-section" style="background-image: url(../<?php echo $data['product_image']; ?>);">
                                                        <div class="info">
                                                            <h6 class="text-white"><?php echo $data['product_name']; ?></h6>
                                                            <p class="text-white"><?php echo $data['product_info']; ?></p>
                                                        </div>
                                                    </div>
                                                </div>
                                        <?php
