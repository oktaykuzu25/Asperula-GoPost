...
<head>
    ...
    <title>Gider Raporu | Asperula Kafe - Sipariş Sistemi Paneli </title>
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Gider Raporu</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                            <div class="widget-content widget-content-area br-8">
                                <div class="container">
                                    <form action="app-expense-report.php" method="POST">
...
if (empty($data['day_endoftheday'])) {
    ...
    echo $data['day_endoftheday'];
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                            <div class="widget-content widget-content-area br-8">
                                <div class="container">
                                    <h1 class="text-center mt-3">Gider Ürün
                                    </h1>
                                    <div class="table-responsive">
                                        <table class="excel-table table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                if (is_array($fetchDataOrderForExpenseProduct)) {
                                                    $sn = 1;
                                                    $totalExpensePrice = 0;

                                                    foreach ($fetchDataOrderForExpenseProduct as $dataOrderItems) {
                                                        $paymentTypeId = $dataOrderItems['expense_paymentype'];
                                                        $fetchDataPaymentTypesForExpenseProduct = fetch_data_payment_types_for_end_of_day($db, $tableNamePaymentTypes, $columnsPaymentTypes, $paymentTypeId);
                                                        $totalPrice = $dataOrderItems['total_expense_price'];
                                                        $totalExpensePrice += $totalPrice;
                                                ?>
                                                        <tr>
                                                            <td><?php echo $dataOrderItems['expense_type'] ?></td>
                                                            <td><?php echo $dataOrderItems['expense_explanation'] ?></td>
                                                            <td><?php echo $fetchDataPaymentTypesForExpenseProduct['payment_types_name'] ?></td>
