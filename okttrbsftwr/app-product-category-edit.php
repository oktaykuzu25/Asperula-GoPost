...
<head>
    ...
    <title><?php echo $fetchDataProductCategoryDetails['product_category_name'] ?> Duzenleme | Asperula Kafe - Sipariş Sistemi Paneli </title>
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Kategoriler Düzenleme</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-12">
                            <div class="alert alert-arrow-right alert-icon-right alert-light-danger alert-dismissible fade show mb-4" role="alert">
                                ...
                                <strong>Dikkat: </strong> Kategori güncellerken, kategorilerin doğru ve mantıklı bir şekilde sınıflandırıldığından emin olun. Bu, müşterilerin aradıkları ürünleri kolayca bulmalarına yardımcı olacaktır.</a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Kategori İsmi</h5>
                                    <p class="card-text">Kategori ismini güncellerken, adın net ve açıklayıcı olmasına özen gösterin. Müşterilerin hangi ürünlerin bu kategori altında bulunacağını kolayca anlamaları gereklidir.
                                    </p>
                                </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6  mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Kategori Açıklaması</h5>
                                    <p class="card-text">Kategori açıklamasını güncellerken, içeriğin doğru ve bilgilendirici olmasına dikkat edin. Bu, müşterilerin kategori hakkında net bilgi sahibi olmasını sağlar.
                                    </p>
                                </div>
                                <div class="card-footer px-4 pt-0 border-0">
                                    <a href="pages-faq.php" target="_blank">Sıkça Sorulan Sorular</a>
                        ...
                        <form action="app-product-category-edit.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-4 layout-spacing layout-top-spacing">
                                        ...
                                        <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div class="widget-content widget-content-area ecommerce-create-section">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-sm-12">
                                                        <label for="product_category_name">Kategori Adı</label>
                                                        <input type="text" class="form-control" id="product_category_name" name="product_category_name" value="<?php echo $fetchDataProductCategoryDetails['product_category_name'] ?>">
                                                        <input type="hidden" class="form-control" name="product_category_id" value="<?php echo $fetchDataProductCategoryDetails['product_category_id'] ?>">
                                                    </div>
                                                </div>

                                                <div class="row mb-4">
                                                    <div class="col-sm-12">
                                                        <label for="product_category_description">Kategori Açıklaması</label>
                                                        <textarea name="product_category_description" class="form-control" id="product_category_description" cols="30" rows="5"><?php echo $fetchDataProductCategoryDetails['product_category_description'] ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xxl-12">
                                                                <div class="switch form-switch-custom switch-inline form-switch-secondary">
                                                                    <input class="switch-input" type="checkbox" role="switch" name="product_category_publicy" <?php echo ($fetchDataProductCategoryDetails['product_category_publicy'] == '1') ? 'checked' : ''; ?> id="product_category_publicy">
                                                                    <label class="switch-label" for="product_category_publicy">Kategori Durumu</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-xxl-12 col-xl-4 col-lg-4 col-md-5 mt-4">
                                                    <div class="widget-content widget-content-area ecommerce-create-section">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <button class="btn btn-primary w-100" type="submit" name="category-update">Kategori Duzenle</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
