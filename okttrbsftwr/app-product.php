...
<head>
    ...
    <title>Ürün Listesi | Asperula Kafe - Sipariş Sistemi Paneli </title>
...
<body class="layout-boxed">
                                ...
                                <table id="invoice-list" class="table dt-table-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Kategori</th>
                                            <th>İsim</th>
                                            <th>Küçük B. Fiyatı</th>
                                            <th>Orta B. Fiyatı</th>
                                            <th>Büyük B. Fiyatı</th>
                                            <th>Normal Fiyatı</th>
                                            <th>Yüklenme T.</th>
                                            <th>Durumu</th>
                                            <th>Aksiyon</th>
                                    ...
                                    <tbody>
                                        ...
                                        if (is_array($fetchDataProduct)) {
                                            ...
                                            foreach ($fetchDataProduct as $data) {
                                                $product_category_detail_name = $data['product_category_id'];
                                                $fetchDataCategoryName = fetch_data_category_detail($db, $tableNameProductCategory, $columnsProductCategory, $product_category_detail_name);
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="align-self-center mb-0 user-name"><?php echo $fetchDataCategoryName['product_category_name'] ?></p>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex">
                                                            <div class="usr-img-frame me-2 rounded-circle">
                                                                <img alt="avatar" class="img-fluid rounded-circle" src="../<?php echo $data['product_image'] ?>">
                                                            </div>
                                                            <p class="align-self-center mb-0 user-name"><?php echo $data['product_name'] ?></p>
                                                        </div>
                                                    </td>
                                                    <td><?php
                                                        if (isset($data['product_small_price'])) {
                                                            if ($data['product_small_price'] != null) {
                                                                echo '<span class="badge badge-light-info inv-status">' . $data['product_small_price'] . ' ₺</span>';
                                                            } else {
                                                                echo '<span class="badge badge-light-danger inv-status">Bulunamadi</span>';
                                                            }
                                                        }
                                                        ?></td>
                                                    <td><?php
                                                        if (isset($data['product_middle_price'])) {
                                                            if ($data['product_middle_price'] != null) {
                                                                echo '<span class="badge badge-light-info inv-status">' . $data['product_middle_price'] . ' ₺</span>';
                                                            } else {
                                                                echo '<span class="badge badge-light-danger inv-status">Bulunamadi</span>';
                                                            }
                                                        }
                                                        ?></td>
                                                    <td><?php
                                                        if (isset($data['product_big_price'])) {
                                                            if ($data['product_big_price'] != null) {
                                                                echo '<span class="badge badge-light-info inv-status">' . $data['product_big_price'] . ' ₺</span>';
                                                            } else {
                                                                echo '<span class="badge badge-light-danger inv-status">Bulunamadi</span>';
                                                            }
                                                        }
                                                        ?></td>
                                                    <td><?php
                                                        if (isset($data['product_normal_price'])) {
                                                            if ($data['product_normal_price'] != NULL) {
                                                                echo '<span class="badge badge-light-info inv-status">' . $data['product_normal_price'] . ' ₺</span>';
                                                            } else {
                                                                echo '<span class="badge badge-light-danger inv-status">Bulunamadi</span>';
                                                            }
                                                        }
                                                    ...
                                                    <td><span class="inv-date"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar">
                                                            ...
                                                            </svg> <?php echo $data['product_currentDateTime'] ?> </span></td>
                                                    <td><?php
                                                        if (isset($data['product_publicy'])) {
                                                            if ($data['product_publicy'] == 1) {
                                                    ...
                                                    <td>
                                                        <a class="badge badge-light-primary text-start me-2 action-edit" href="app-product-edit.php?<?php echo $url ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3">
                                                                <path d="M12 20h9"></path>
                                                                <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path>
                                                            </svg></a>
                                                        <a class="badge badge-light-danger text-start action-delete" href="app-product.php?deleteProduct=<?php echo $data['product_id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash">
    ...
    <script src="../src/assets/js/apps/product-list.js"></script>
