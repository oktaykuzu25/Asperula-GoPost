...
if (isset($_SERVER['REQUEST_URI'])) {
    ...
    $order_id = end($url_segments);
    $id = validate($order_id);
    $fetchDataOrderİtemsTableForAdditionsDetailPage = fetch_data_order_items_for_additions_detail_page($db, $tableNameOrderItems, $columnsOrderItems, $id);
}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Adisyonlar | Asperula Kafe - Sipariş Sistemi Paneli </title>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    ?>
                        ...
                        <li class="menu active">
                            <a href="./app-additions.php" aria-expanded="true" class="dropdown-toggle">
                                <div class="">
            ...
            <div class="layout-px-spacing">
                <div class="middle-content container-xxl p-0">
                    <div class="row layout-top-spacing">
                                                ...
                                                <div class="your-order-area">
                                                        ...
                                                        <div class="your-order-info-wrap">
                                                            ...
                                                            <div class="your-order-middle">
                                                                <ul>
                                                                    ...
                                                                    <?php
                                                                    if (is_array($fetchDataOrderİtemsTableForAdditionsDetailPage)) {
                                                                        foreach ($fetchDataOrderİtemsTableForAdditionsDetailPage as $data) {

                                                                            $order_id = $data['order_id'];
                                                                            $product_id = $data['product_id'];
                                                                            $product_category_id = $data['product_category_id'];

                                                                            $fetchDataCategoryTableForAdditionsDetailPage = fetch_data_category_for_additions_detail_page($db, $tableNameProductCategory, $columnsProductCategory, $product_category_id);
                                                                            $fetchDataProductTableForAdditionsDetailPage = fetch_data_product_for_additions_detail_page($db, $tableNameProduct, $columnsProduct, $product_id);
                                                                            $fetchDataOrderItemsTotalPriceTableDetail = fetch_data_order_items_total_price_for_additions($db, $tableNameOrderItems, $columnsOrderItems, $order_id);
                                                                            $fetchDataOrdersTableForAdditionsDetailPage = fetch_data_orders_for_additions_detail_page($db, $tableNameOrders, $columnsOrders, $order_id);

                                                                            $totalPrice = $fetchDataOrderItemsTotalPriceTableDetail;
                                                                    ...
                                                                    ?>
                                                                            <li>
                                                                                ...
                                                                                <?php echo $data['product_name']; ?> X 1
                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        echo '<div class="col-12">' . $fetchDataOrderİtemsTableForAdditionsDetailPage . '</div>';
                                                                    }
                                                                    ?>


                                                                    <li>
                                                                        <form method="post" action="app-additions-detail.php">
                                                                            <div class="discount-button">
                                                                                <button name="clear-cart" type="submit">Sepeti Temizle</button>
                                                                            </div>
                                                                        </form>
                                                                    </li>
                                                            ...
                                                            <?php
                                                            if ($fetchDataOrdersTableForAdditionsDetailPage['order_activity'] == 0) {
                                                            ?>
                                                            <?php
                                                            } else {
                                                            ?>
                                                                ...
                                                                <div class="your-order-info order-shipping">
                                                                    <ul>
                                                                        <li>İskonto
                                                                            <p>
                                                                            <form method="post" action="app-additions-detail.php">
                                                                                <input type="text" name="discount" placeholder="İskonto Yüzdesi" style="background-color: white; border-color:#fa5832; border:0,2px; margin-top:5px;">
                                                                                <div class="discount-button">
                                                                                    <button name="discount-add">İskonto</button>
                                                                                </div>
                                                                            </form>
                                                                            </p>
                                                                        </li>
                                                    ...
                                                    ?>
                                                        <form method="POST" action="index.php">
                                                            <div class="payment-method">
                                                                ...
                                                                ?>
                                                                        <div class="pay-top sin-payment">
                                                                            <input id="<?php echo $data['payment_types_name'] ?>" class="input-radio" type="radio" value="<?php echo $data['id'] ?>" name="payment_types_name">
                                                                            <label for="<?php echo $data['payment_types_name'] ?>"><?php echo $data['payment_types_name'] ?></label>
                                                                        </div>
                                                                <?php
                                                                        $sn++;
                                                                    }
                                                            ...
                                                            <?php } ?>
                                                            <div class="Place-order discount-button">
                                                                <button type="submit" name="order-self">Onayla</button>
                                                            </div>
                                                        </form>
                                                        ...
                                                        <form method="POST" action="index.php">
                                                            ...
                                                            <?php } ?>
                                                            <div class="Place-order discount-button">
                                                                <button type="submit" name="order-self-close">Kapat</button>
                                                            </div>
                                                        </form>
                                                    <?php
                                                    }
                        ...
                        <div class="row col-xl-7 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                            <div class="row scrollable">
                                <?php
                                // Assuming $fetchDataOrderItemsTableForAdditionsDetailPage is the returned data array
                                if (is_array($fetchDataOrderİtemsTableForAdditionsDetailPage)) {
                                    foreach ($fetchDataOrderİtemsTableForAdditionsDetailPage as $data) {
                                        ...
                                        $fetchDataProductTableForAdditionsDetailPage = fetch_data_product_for_additions_detail_page($db, $tableNameProduct, $columnsProduct, $product_id);
                                ?>
                                        <div class="col-xxl-4 col-xl-6 col-lg-3 col-md-4 col-sm-6 mb-4">
                                            <a href="#" class="card style-2 mb-md-0 mb-4">
                                                <!-- Example fields; replace with actual data from $data array -->
                                                <img src="../<?php echo $fetchDataProductTableForAdditionsDetailPage['product_image']; ?>" class="card-img-top" alt="...">
                                                <div class="card-body px-0 pb-0">
                                                    <p class="card-title" style="font-size: 15px;"><?php echo $fetchDataCategoryTableForAdditionsDetailPage['product_category_name']; ?></p>
                                                    <h5 class="card-title mb-3"><?php echo $data['product_name']; ?></h5>
                                                    <div class="media mt-4 mb-0 pt-1">
                                                        <div class="media-body">
                                                            <h4 class="media-heading mb-1"><?php echo $data['product_size']; ?></h4>
                                                            <p class="media-text">₺<?php echo number_format($data['product_price'], 2); ?></p>
                                                            <!-- Example: Replace 'price' with actual column name from your database -->
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>
                                ...
                                <?php
                                    ...
                                    echo '<div class="col-12">' . $fetchDataOrderItemsTableForAdditionsDetailPage . '</div>';
                                }
                                ?>
                            </div>
                        </div>
