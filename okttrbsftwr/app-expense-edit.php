...
<head>
    ...
    <title>Asperula Kafe -Gider Güncelleme </title>
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active">
                        <a href="#accounts" data-bs-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                                <svg width="64px" height="64px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        ...
                        <ul class="collapse submenu list-unstyled show" id="accounts" data-bs-parent="#accordionExample">
                            <li>
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Gider Güncelleme</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-12">
                            <div class="alert alert-arrow-right alert-icon-right alert-light-danger alert-dismissible fade show mb-4" role="alert">
                                ...
                                <strong>Dikkat: </strong> Gider güncellerken lütfen tüm bilgileri doğru ve eksiksiz doldurduğunuzdan emin olun. Yanlış veya eksik bilgi, siparişlerin doğru şekilde alınmasını ve işlenmesini engelleyebilir. </a>
                            </div>
                        </div>
                        ...
                        <form action="app-expense-edit.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-4 layout-spacing layout-top-spacing">
                                        ...
                                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div class="widget-content widget-content-area ecommerce-create-section">
                                                ...
                                                <div class="row mb-4">
                                                <div class="col-sm-6">
                                                        <label for="product_name">Gider Açıklama </label>
                                                        <input type="text" class="form-control" name="expense_explanation" value="<?php echo $fetchDataExpenseUpdate['expense_explanation']; ?>" >
                                                        <input type="hidden" class="form-control" name="expense_id" value="<?php echo $fetchDataExpenseUpdate['expense_id'] ?>">
                                                
                                                    </div>
                                                    <div class="col-sm-6">
                                                    <label for="product_category_id"> Gider Türü</label>
                                                    <select class="form-select" id="product_category_id" name="expense_type" value="<?php echo $fetchDataExpenseUpdate['expense_type']; ?>">
                                                        <option value="Gider">Gider </option>
                                                     
                                                    </select>
                                                </div>
                                                    <div class="col-sm-6 mt-2">
                                                        <label for="product_name">Gider Tutar </label>
                                                        <input type="text" class="form-control" name="expense_amount" value="<?php echo $fetchDataExpenseUpdate['expense_amount']; ?>" >
                    
                                                    </div>
                                                    <div class="col-sm-6 mt-2">
    <label for="product_category_id">Ödeme Tipi</label>
    <select class="form-select" id="product_category_id" name="expense_paymentype">
        <option value="">Seçiniz</option>
        <?php
        if (is_array($fetchDataPaymentTypes)) {
            foreach ($fetchDataPaymentTypes as $data) {
                $selected = ($data['id'] == $fetchDataExpenseUpdate['expense_paymentype']) ? 'selected' : '';
        ?>
                <option value="<?php echo $data['id'] ?>" <?php echo $selected; ?>><?php echo $data['payment_types_name'] ?></option>
        <?php
            }
        } else {
            echo $fetchDataPaymentTypes;
                                                ...
                                                <div class="col-sm-12">
                                                    <button class="btn btn-primary w-100" type="submit" name="app-expense-update">Gider Güncelle</button>
                                                </div>
