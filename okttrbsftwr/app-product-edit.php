...
<head>
    ...
    <title><?php echo $fetchDataProductDetails['product_name'] ?> Düzenleme | Asperula Kafe - Sipariş Sistemi Paneli </title>
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Ürün Düzenleme</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-12">
                            <div class="alert alert-arrow-right alert-icon-right alert-light-danger alert-dismissible fade show mb-4" role="alert">
                                ...
                                <strong>Dikkat: </strong> Ürün güncellerken lütfen tüm bilgileri doğru ve eksiksiz olarak güncellediğinizden emin olun. Yanlış veya eksik bilgi, siparişlerin doğru şekilde işlenmesini ve teslimat sürecinin aksamasına neden olabilir. </a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Ürün Adı</h5>
                                    <p class="card-text">Ürün adını net ve açıklayıcı bir şekilde güncellediğinizden emin olun. Müşterilerin ürünü kolayca tanıyabilmesi için isimde spesifik detaylar yer almalıdır.</p>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6  mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Fiyat Bilgisi</h5>
                                    <p class="card-text">Ürünün fiyatını doğru şekilde güncellediğinizden, tüm vergilerin dahil olduğundan emin olun. Fiyatlandırma hatası müşteri memnuniyetsizliğine yol açabilir.</p>
                                </div>
                                <div class="card-footer px-4 pt-0 border-0">
                                    <a href="pages-faq.php" target="_blank">Sıkça Sorulan Sorular</a>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6  mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Ürün Açıklaması</h5>
                                    <p class="card-text">Ürünün içeriği, malzemeleri ve varsa alerjen bilgilerini detaylı bir şekilde güncelleyin. Bu, müşterilerin doğru ürünü seçmesine yardımcı olur ve alerjik reaksiyonları önler.</p>
                                </div>
                                <div class="card-footer px-4 pt-0 border-0">
                                    <a href="pages-faq.php" target="_blank">Sıkça Sorulan Sorular</a>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6  mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Ürün Görseli</h5>
                                    <p class="card-text">Ürünün yüksek kaliteli ve çekici bir fotoğrafını güncelleyin. Görseller müşterilerin ilgisini çeker ve satın alma kararını olumlu yönde etkiler.</p>
                                </div>
                                <div class="card-footer px-4 pt-0 border-0">
                                    <a href="pages-faq.php" target="_blank">Sıkça Sorulan Sorular</a>
                                </div>
                        ...
                        <form action="app-product-edit.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="widget-content widget-content-area ecommerce-create-section">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input type="text" class="form-control" id="product_name" name="product_name" value="<?php echo $fetchDataProductDetails['product_name'] ?>">
                                                        <input type="hidden" name="product_id" class="form-control" value="<?php echo $fetchDataProductDetails['product_id'] ?>">
                                                    </div>
                                                </div>

                                                <div class="row mb-4">
                                                    <div class="col-sm-12">
                                                        <label for="product_info">Ürün Hakkında</label>
                                                        <textarea name="product_info" class="form-control" id="product_info" cols="30" rows="5"><?php echo $fetchDataProductDetails['product_info'] ?></textarea>
                                                    </div>
                                                </div>

                                                <div class="row mb-2">
                                                    <div class="col-sm-3 mb-4">
                                                        <label for="product_small_price">Küçük Boy Ürün Fiyatı</label>
                                                        <input type="text" class="form-control" id="product_small_price" name="product_small_price" value="<?php echo $fetchDataProductDetails['product_small_price'] ?>">
                                                    </div>
                                                    <div class="col-sm-3 mb-4">
                                                        <label for="product_middle_price">Orta Boy Ürün Fiyatı</label>
                                                        <input type="text" class="form-control" id="product_middle_price" name="product_middle_price" value="<?php echo $fetchDataProductDetails['product_middle_price'] ?>">
                                                    </div>
                                                    <div class="col-sm-3 mb-4">
                                                        <label for="product_big_price">Büyük Boy Ürün Fiyatı</label>
                                                        <input type="text" class="form-control" id="product_big_price" name="product_big_price" value="<?php echo $fetchDataProductDetails['product_big_price'] ?>">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <label for="product_normal_price">Normal Ürün Fiyatı</label>
                                                        <input type="text" class="form-control" id="product_normal_price" name="product_normal_price" value="<?php echo $fetchDataProductDetails['product_normal_price'] ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-md-12">
                                                        <img class="form-control file-upload-input" src="../<?php echo $fetchDataProductDetails['product_image'] ?>" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xxl-12 mb-4">
                                                                <div class="switch form-switch-custom switch-inline form-switch-secondary">
                                                                    <input class="switch-input" type="checkbox" role="switch" name="product_publicy" id="product_publicy" <?php echo ($fetchDataProductDetails['product_publicy'] == '1') ? 'checked' : ''; ?>>
                                                                    <label class="switch-label" for="product_publicy">Ürün Durumu</label>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <select class="form-select" id="product_category_id" name="product_category_id">
                                                                    ...
                                                                    if (is_array($fetchDataProductCategory)) {
                                                                        foreach ($fetchDataProductCategory as $data) {
                                                                            $selected = ($data['product_category_id'] == $fetchDataProductDetails['product_category_id']) ? 'selected' : '';
                                                                    ?>
                                                                            <option value="<?php echo $data['product_category_id'] ?>" <?php echo $selected ?>><?php echo $data['product_category_name'] ?></option>
                                                                    <?php
                                                                        }
                                                                    } else {
                                                ...
                                                <div class="col-xxl-12 col-xl-4 col-lg-4 col-md-5 mt-4">
                                                    <div class="widget-content widget-content-area ecommerce-create-section">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <button class="btn btn-primary w-100" type="submit" name="product-update">Ürün Düzenle</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
