...
<head>
    ...
    <title>Gün Sonu Raporu | Asperula Kafe - Sipariş Sistemi Paneli </title>
    ...
    <style>
        ...
        .excel-table tbody tr:last-of-type {
            ...
            /* Son satırın üst çizgisini kalın yap */
            font-weight: bold;
            /* Son satırın yazı stilini kalın yap */
        }
...
<body class="layout-boxed">
                ...
                <div class="profile-info">
                    <div class="user-info">
                        ...
                        <div class="profile-content">
                            <h6 class=""><?php $users_name = $_SESSION['users_name'];
                                            echo $users_name ?></h6>
                            <p class=""><?php $users_role_session = $_SESSION['users_role'];
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    ?>
                        ...
                        <li class="menu active">
                            <a href="#report" data-bs-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                                <div class="">
                            ...
                            <ul class="collapse submenu list-unstyled show" id="report" data-bs-parent="#accordionExample">
                                <li>
                                    <a href="./app-report.php"> Genel Rapor </a>
                                </li>
                                <li class="active">
                                    <a href="./app-end-of-day-report.php"> Gün Sonu Raporu </a>
                                </li>
                                <li>
                                    <a href="./app-product-sales-report.php"> Ürün Satış Raporu </a>
                                </li>
                                <li>
                                    <a href="./app-expense-report.php"> Gider Raporu </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="menu">
                            ...
                            <ul class="collapse submenu list-unstyled" id="stock" data-bs-parent="#accordionExample">
                                ...
                                <li>
                                    <a href="./stock-movements.php"> Stok Hareketleri </a>
                                </li>
                                <li>
                        ...
                        <li class="menu">
                            ...
                            <ul class="collapse submenu list-unstyled" id="settings" data-bs-parent="#accordionExample">
                                ...
                                <li>
                                    <a href="./app-tables-settings.php"> Masalar </a>
                                </li>
                            </ul>
                        </li>
                    <?php
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="app-stock.php">Raporlar</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Gün Sonu Raporu</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                            <div class="widget-content widget-content-area br-8">
                                <div class="container">
                                    <form action="app-end-of-day-report.php" method="POST">
                                        <div class="row mb-4 mt-4 align-items-center">
                                            <div class="col-xxl-8 col-md-8">
                                                <select class="form-select" id="day_operations" name="day_operations">
                                                    <?php
                                                    if (is_array($fetchDataDayOperations)) {
                                                        $sn = 1;
                                                        foreach ($fetchDataDayOperations as $data) {
                                                            $selected = ($data['day_id'] == $_POST['day_operations']) ? 'selected' : '';
                                                    ?>
                                                            <option value="<?php echo $data['day_id'] ?>" <?php echo $selected ?>><?php echo $data['day_perday'] ?> || <?php

                                                                                                                                                                        if (empty($data['day_endoftheday'])) {
                                                                                                                                                                            echo '01-01-2030 23:59:59';
                                                                                                                                                                        } else {
                                                                                                                                                                            echo $data['day_endoftheday'];
                                                                                                                                                                        }
                                                                                                                                                                        ?></option>
                                                    <?php
                                                            $sn++;
                                            ...
                                            <div class="col-xxl-4 col-md-4">
                                                <button class="btn btn-primary d-block d-md-inline-block mb-3 mb-md-0" type="submit" name="report-filter" style="width: 100%;">
                                                    <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                        <g id="SVGRepo_iconCarrier">
                                        ...
                                        <div class="row mb-4 mt-4 align-items-center">
                                            <div class="col-xxl-4 col-md-4">
                                                <div class="form-group mb-0">
                                                    <input type="datetime-local" class="form-control" id="day_perday" name="day_perday" style="width: 100%;">
                                                </div>
                                            </div>
                                            <div class="col-xxl-4 col-md-4">
                                                <div class="form-group mb-0">
                                                    <input type="datetime-local" class="form-control" id="day_endoftheday" name="day_endoftheday" style="width: 100%;">
                                                </div>
                                            </div>
                                            <div class="col-xxl-4 col-md-4">
                                                <button class="btn btn-primary d-block d-md-inline-block mb-3 mb-md-0" type="submit" name="date-report-filter" style="width: 100%;">
                                                    <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                        <g id="SVGRepo_iconCarrier">
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                            <div class="widget-content widget-content-area br-8">
                                <div class="container">
                                    <h1 class="text-center mt-3">Toplam Gelir/Gider
                                    </h1>
                                    <div class="table-responsive">
                                        <table class="excel-table table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    <th>Tipler</th>
                                                    <th>Gelir</th>
                                            ...
                                            <tbody>
                                                <?php
                                                if (is_array($fetchDataOrderItemsForEndOfDay)) {
                                                    $sn = 1;
                                                    ...
                                                    foreach ($fetchDataOrderItemsForEndOfDay as $dataOrderItems) {
                                                        $paymentTypesId = $dataOrderItems['payment_type'];
                                                        $fetchDataPaymentTypesForEndOfDay = fetch_data_payment_types_for_end_of_day($db, $tableNamePaymentTypes, $columnsPaymentTypes, $paymentTypesId);

                                                        $fetchDataExpenseForEndOfDay = fetch_data_expense_for_end_of_day($db, $tableNameExpense, $columnsExpense, $paymentTypesId, $day_perday, $day_endoftheday);

                                                        if (is_array($fetchDataExpenseForEndOfDay) && isset($fetchDataExpenseForEndOfDay['total_expense_price'])) {
                                                            $dataExpense = $fetchDataExpenseForEndOfDay;
                                                        } else {
                                                            $dataExpense = ['total_expense_price' => 0];
                                                        }

                                                        $totalPrice = $dataOrderItems['total_price'];
                                                        $totalExpense = isset($dataExpense['total_expense_price']) ? $dataExpense['total_expense_price'] : 0;
                                                        $remainingAmount = $totalPrice - $totalExpense;

                                                        // Toplamları hesapla
                                                        $totalOrderPrice += $totalPrice;
                                                        $totalExpensePrice += $totalExpense;
                                                        $totalRemainingAmount += $remainingAmount;
                                                ?>
                                                        <tr>
                                                            <td><?php echo $fetchDataPaymentTypesForEndOfDay['payment_types_name'] ?></td>
                                                ...
                                                <?php
                                                    ...
                                                    echo "Veriler bulunamadı.";
                                                }
                                                ?>

                                                <tr>
                                                    <td style="font-weight: bold;">Total</td>
                                                    <td style="font-weight: bold;">₺<?php echo number_format($totalOrderPrice, 2); ?></td>
                                                    <td style="font-weight: bold;">₺<?php echo number_format($totalExpensePrice, 2); ?></td>
                                                    <td style="font-weight: bold;">₺<?php echo number_format($totalRemainingAmount, 2); ?></td>
                                                </tr>
                                            </tbody>
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                            <div class="widget-content widget-content-area br-8">
                                <div class="container">
                                    <h1 class="text-center mt-3">Kullanıcı Satışları </h1>
                                    <div class="table-responsive">
                                        <table class="excel-table table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                <?php
                                                if (is_array($fetchDataOrderItemsForUserSales)) {
                                                    $sn = 1;

                                                    $totalOrderPrice = 0;

                                                    foreach ($fetchDataOrderItemsForUserSales as $dataOrderItems) {
                                                        $usersId = $dataOrderItems['users_id'];
                                                        $fetchDataUsersForUserSales = fetch_data_users_for_user_sales($db, $tableNameUsers, $columnsUsers, $usersId);
                                                ...
                                                ?>
                                                        <tr>
                                                            <td><?php echo $fetchDataUsersForUserSales['users_name'] ?></td>
                                                            <td>₺<?php echo number_format($totalPrice, 2); ?></td>
                                                        </tr>
                                                <?php
                                                        $sn++;
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                            <div class="widget-content widget-content-area br-8">
                                <div class="container">
                                    <h1 class="text-center mt-3">Ödeme Almış Kullanıcılar</h1>
                                    <div class="table-responsive">
                                        <table class="excel-table table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                <?php
                                                if (is_array($fetchDataOrderItemsForUsersWhoSales)) {
                                                    $sn = 1;

                                                    $totalOrderPrice = 0;

                                                    foreach ($fetchDataOrderItemsForUsersWhoSales as $dataOrderItems) {
                                                        $usersId = $dataOrderItems['users_id'];
                                                        $paymentTypeId = $dataOrderItems['payment_type'];
                                                        $fetchDataUsersForUsersWhoSales = fetch_data_users_for_user_sales($db, $tableNameUsers, $columnsUsers, $usersId);
                                                        $fetchDataPaymentTypesForUsersWhoSales = fetch_data_payment_types_for_end_of_day($db, $tableNamePaymentTypes, $columnsPaymentTypes, $paymentTypeId);
                                                        $totalPrice = $dataOrderItems['total_price'];
                                                        // Toplamları hesapla
                                                        $totalOrderPrice += $totalPrice;
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $fetchDataUsersForUsersWhoSales['users_name'] ?></td>
                                                            <td><?php echo $fetchDataPaymentTypesForUsersWhoSales['payment_types_name'] ?></td>
                                                            <td>₺<?php echo number_format($totalPrice, 2); ?></td>
                                                        </tr>
                                                <?php
                                                        $sn++;
                                                ...
                                                ?>
                                                <tr>
                                                    <td style="font-weight: bold;" colspan="2">Toplam Tutar</td>
                                                    <td style="font-weight: bold;">₺<?php echo number_format($totalOrderPrice, 2); ?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                            <div class="widget-content widget-content-area br-8">
                                <div class="container">
                                    <h1 class="text-center mt-3">Bölge Satışları </h1>
                                    <div class="table-responsive">
                                        <table class="excel-table table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                <?php
                                                if (is_array($fetchDataOrderItemsForRegionalSales)) {
                                                    $sn = 1;

                                                    $totalOrderPrice = 0;

                                                    foreach ($fetchDataOrderItemsForRegionalSales as $dataOrderItems) {
                                                        $businessId = $dataOrderItems['business_id'];
                                                        $paymentTypeId = $dataOrderItems['payment_type'];
                                                        $fetchDataBusinessForRegionalSales = fetch_data_business_for_regional_sales($db, $tableNameBusiness, $columnsBusiness, $businessId);
                                                        $fetchDataPaymentTypesForRegionalSales = fetch_data_payment_types_for_end_of_day($db, $tableNamePaymentTypes, $columnsPaymentTypes, $paymentTypeId);
                                                        $totalPrice = $dataOrderItems['total_price'];
                                                        // Toplamları hesapla
                                                        $totalOrderPrice += $totalPrice;
                                                ?>
                                                        <tr>
                                                            <td><?php echo $fetchDataBusinessForRegionalSales['business_name'] ?></td>
                                                            <td><?php echo $fetchDataPaymentTypesForRegionalSales['payment_types_name'] ?></td>
                                                            <td>₺<?php echo number_format($totalPrice, 2); ?></td>
                                                    <?php
                                                        $sn++;
                                                    }
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                            <div class="widget-content widget-content-area br-8">
                                <div class="container">
                                    <h1 class="text-center mt-3">Genel Bilgiler </h1>
                                    <div class="table-responsive">
                                        <table class="excel-table table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                <?php
                                                $fetchDataOrderForGeneralInformation = fetch_data_order_for_general_information($db, $tableNameOrders, $columnsOrders, $day_perday, $day_endoftheday);

                                                if (is_array($fetchDataOrderForGeneralInformation)) {
                                                    $sn = 1;
                                                    ...
                                                    foreach ($fetchDataOrderForGeneralInformation as $dataOrder) {
                                                        $totalOrderCount = isset($fetchDataOrderForGeneralInformation['unique_orders']) ? $fetchDataOrderForGeneralInformation['unique_orders'] : 0;

                                                        $fetchDataOrderItemsForGeneralInformation = fetch_data_order_items_for_general_information($db, $tableNameOrderItems, $columnsOrderItems, $day_perday, $day_endoftheday);
                                                        $fetchDataExpenseForGeneralInformation = fetch_data_expense_for_general_information($db, $tableNameExpense, $columnsExpense, $day_perday, $day_endoftheday);

                                                        if (is_array($fetchDataExpenseForGeneralInformation) && isset($fetchDataExpenseForGeneralInformation['total_expense_price'])) {
                                                            $dataExpense = $fetchDataExpenseForGeneralInformation;
                                                        } else {
                                                            $dataExpense = ['total_expense_price' => 0];
                                                        }

                                                        if (is_array($fetchDataOrderItemsForGeneralInformation) && !empty($fetchDataOrderItemsForGeneralInformation)) {
                                                            $totalPrice = $fetchDataOrderItemsForGeneralInformation['total_price'];
                                                        } else {
                                                            $totalPrice = 0;
                                                        }
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $totalOrderCount; ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Genel Toplam</td>
                                                ...
                                                <tr>
                                                    <td>Giderler</td>
                                                    <td>₺<?php echo number_format($totalExpensePrice, 2); ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Alınmış Ödemeler</td>
                                                    <td>₺<?php echo number_format($totalOrderPrice, 2); ?></td>
                                                </tr>

                                                <tr>
                                                    <td style="font-weight: bold;">Net</td>
                                                    <td style="font-weight: bold;">₺<?php echo number_format($totalOrderPrice - $totalExpensePrice, 2); ?></td>
                                                </tr>
                                            </tbody>
    ...
    <script>
        ...
        document.getElementById('day_perday').value = getOneDayBeforeISO();
        document.getElementById('day_endoftheday').value = getCurrentDateTimeISO();
    </script>
</body>
