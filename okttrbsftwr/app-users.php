...
<body class="layout-boxed">
                                    ...
                                    <tbody>
                                        ...
                                        if (is_array($fetchDataUsers)) {
                                            ...
                                            foreach ($fetchDataUsers as $data) {
                                                $product_category_name_url = $data['users_name'];
                                                $product_category_id_url = $data['users_id'];

                                                $usersIdForBusiness=$data['business_name'];

                                                $fetchDataAppUsersForBusiness = fetch_data_users_business_detail($db, $tableNameBusiness, $columnsBusinessCategory, $usersIdForBusiness);
                                        ...
                                        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <p class="align-self-center mb-0 user-name"> <?php echo $data['users_name'] ?></p>
                                                        </div>
                                                    </td>
                                                    <td><span class="inv-amount"><?php echo $fetchDataAppUsersForBusiness['business_name']?></span></td>
                                                    <td>
                                                    <?php
                                                        if (isset($data['users_role'])) {
                                                            if ($data['users_role'] == 1) {
                                                                echo '<span class="inv-amount">Admin</span>';
                                                            } else {
                                                                echo '<span class="inv-amount">Personel</span>';
                                                            }
                                                        }
                                                        ?>
                                                    </td>
                                                    <td><span class="inv-amount"><?php echo $data['users_currentDateTime'] ?></span></td>

                                                    <td>
                                                        <a class="badge badge-light-primary text-start me-2 action-edit" href="app-users-edit.php?<?php echo $url ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3">
                                                                <path d="M12 20h9"></path>
                                                                <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path>
                                                            </svg></a>
                                                        <a class="badge badge-light-danger text-start action-delete" href="app-users.php?deleteUsersId=<?php echo $data['users_id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash">
    ...
    <script src="../src/assets/js/apps/users-list.js"></script>
