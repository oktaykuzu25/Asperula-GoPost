...
<head>
    ...
    <title>Materyal | Asperula Kafe - Sipariş Sistemi Paneli </title>
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Materyal</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                            ...
                            <div class="widget-content widget-content-area br-8">
                                <table id="zero-config" class="table table-striped dt-table-hover" style="width:100%">
                                    <div class="col-md-12 col-sm-12 col-12 m-2">
                                        <a class="btn btn-primary" href="app-material-add.php">
                                    ...
                                    <thead>
                                        <tr>
                                            <th>Materyal</th>
                                            <th>Materyal Birimi</th>
                                            <th>Materyal Birim Miktarı</th>
                                            <th>Materyal Birim Fiyatı</th>
                                            <th>Tarih</th>
                                            <th>Materyal Durumu</th>
                                            <th class="no-content">Aksiyon</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        if (is_array($fetchDataMaterial)) {
                                            $sn = 1;
                                            foreach ($fetchDataMaterial as $data) {
                                                $material_name_url = $data['material_name'];
                                                $material_id_url = $data['material_id'];

                                                $seo_name = cleanTurkishCharacters($material_name_url);

                                                // SEO uyumlu URL'yi oluştur
                                                $url = "/$seo_name" . "/$material_id_url";
                                        ?>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">

                                                            <p class="align-self-center mb-0 admin-name"> <?php echo $data['material_name'] ?> </p>
                                                        </div>
                                                    </td>
                                                    <td><?php echo $data['material_unit'] ?></td>
                                                    <td><?php echo $data['material_unit_amount'] ?></td>
                                                    <td><?php echo $data['material_price'] ?> ₺</td>
                                                    <td><?php echo $data['material_currentDateTime'] ?></td>
                                                    <td><?php
                                                        if (isset($data['material_publicy'])) {
                                                            if ($data['material_publicy'] == 1) {
                                                        ...
                                                        ?></td>
                                                    <td>
                                                        <a href="app-material-edit.php?<?php echo $url ?>">
                                                            <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                                <g id="SVGRepo_iconCarrier">
                                                        ...
                                                        <a href="app-storage.php?deleteMaterial=<?php echo $data['material_id']; ?>">
