...
<head>
    ...
    <title>Ödeme Şekli Ekle | Asperula Kafe - Sipariş Sistemi Paneli </title>
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Ödeme Şekli Ekle</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-12">
                            <div class="alert alert-arrow-right alert-icon-right alert-light-danger alert-dismissible fade show mb-4" role="alert">
                                ...
                                <strong>Dikkat: </strong> Ödeme şekillerini eklerken her bir seçeneğin doğru ve eksiksiz olarak sisteme girildiğinden emin olun. Yanlış veya eksik bilgiler, ödeme süreçlerinde sorunlara yol açabilir ve müşteri memnuniyetini olumsuz etkileyebilir. </a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Ödeme Seçeneklerinin Önemi</h5>
                                    <p class="card-text">Ödeme şekillerini eklerken, her yöntemin doğru bilgilerle sisteme kaydedildiğinden emin olun. Ödeme türü, işlem ücretleri, tedarikçi bilgileri ve geçerlilik süresi gibi detayların eksiksiz girilmesi, ödeme işlemlerinin sorunsuz bir şekilde gerçekleştirilmesini sağlar.</p>
                                </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6  mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Ödeme Şekillerini Eklerken Dikkat Edilmesi Gerekenler</h5>
                                    <p class="card-text">Ödeme şekillerini eklerken, her yöntemin doğru bilgilerle sisteme kaydedildiğinden emin olun. Ödeme türü, işlem ücretleri, tedarikçi bilgileri ve geçerlilik süresi gibi detayların eksiksiz girilmesi, ödeme işlemlerinin sorunsuz bir şekilde gerçekleştirilmesini sağlar. </p>
                                </div>
                                <div class="card-footer px-4 pt-0 border-0">
                                    <a href="pages-faq.php" target="_blank">Sıkça Sorulan Sorular</a>
                        ...
                        <form action="app-payment-types-add.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="widget-content widget-content-area ecommerce-create-section">
                                                <div class="row mb-4">
                                                    <div class="col-sm-12 mb-4">
                                                        ...
                                                        <input type="text" class="form-control" id="payment_types_name" name="payment_types_name">
                                                    </div>
                                                    <div class="col-xxl-12 mb-4">
                                                        <div class="switch form-switch-custom switch-inline form-switch-secondary">
                                                            <input class="switch-input" type="checkbox" role="switch" name="payment_types_publicy" id="payment_types_publicy">
                                                            <label class="switch-label" for="payment_types_publicy">Ödeme Şekli Durumu</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <button class="btn btn-primary w-100" type="submit" name="payment-types-add">Ödeme Şekli Ekle</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
