                                            ...
                                            <div class="widget-content widget-content-area ecommerce-create-section">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" class="form-control" name="product_business">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label for="product_name">Ülke</label>
                                                        <input type="text" class="form-control" name="product_country">
                                                    </div>
                                                </div>

                                                <div class="row mb-4">
                                                    <div class="col-sm-6">
                                                        <label for="product_name">E-mail</label>
                                                        <input type="text" class="form-control" name="product_city">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label for="product_name">İl</label>
                                                        <input type="text" class="form-control" name="product_province">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" class="form-control" name="product_district">
                                                    </div>
                                                    <div class="col-sm-6">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" class="form-control" name="product_telephone">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label for="product_name">Özelliği</label>
                                                        <input type="text" class="form-control" name="product_tip">
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <button class="btn btn-primary w-100" type="submit" name="product-ad-business">İşletme Ekle</button>
                                                </div>
