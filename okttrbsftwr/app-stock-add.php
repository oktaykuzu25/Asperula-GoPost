...
<head>
    ...
    <title>Stok Ürün Ekle | Asperula Kafe - Sipariş Sistemi Paneli </title>
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-12">
                            <div class="alert alert-arrow-right alert-icon-right alert-light-danger alert-dismissible fade show mb-4" role="alert">
                                ...
                                <strong>Dikkat: </strong> Yeni ürünler eklerken her birinin doğru bilgilerle kaydedildiğinden emin olun. Eksik veya yanlış bilgiler, stok yönetiminde aksaklıklara ve envanter hatalarına neden olabilir. </a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Stok Ürün Ekleme</h5>
                                    <p class="card-text">Stok ürün ekleme işlemi, kafe işletmenizin malzeme tedarik sürecini etkili bir şekilde yönetmek için kritik öneme sahiptir. Doğru bilgilerle eklenen ürünler, stok takibinin doğru yapılmasını sağlar ve sipariş süreçlerini hızlandırır.</p>
                                </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6  mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Stok Ürün Ekleme Adımları</h5>
                                    <p class="card-text">Stok ürün eklerken, her ürünün tam ve doğru bilgilerle sisteme kaydedildiğinden emin olun. Ürün adı, kategori, miktar, tedarikçi bilgileri ve barkod gibi bilgiler eksiksiz girilmelidir. Bu adımlar, envanter yönetiminde doğruluğu artırır ve operasyonel verimliliği sağlar.</p>
                                </div>
                                <div class="card-footer px-4 pt-0 border-0">
                                    <a href="pages-faq.php" target="_blank">Sıkça Sorulan Sorular</a>
                                </div>
                        ...
                        <form action="app-stock-add.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="widget-content widget-content-area ecommerce-create-section">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input type="text" class="form-control" id="stock_price" name="stock_price">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="col-xxl-12 col-md-6 mb-4">
                                                            ...
                                                            <select class="form-select" id="stock_processing" name="stock_processing">
                                                                ...
                                                                <option value="Giren Stok">Giren Stok</option>
                                                                <option value="Çıkan Stok">Çıkan Stok</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xxl-12 mb-4">
                                                                <div class="switch form-switch-custom switch-inline form-switch-secondary">
                                                                    <input class="switch-input" type="checkbox" role="switch" name="stock_publicy" id="stock_publicy">
                                                            ...
                                                            <div class="col-xxl-12 col-md-6 mb-4">
                                                                ...
                                                                <select class="form-select" id="storage_id" name="storage_id">
                                                                    ...
                                                                    ?>
                                                                            <option value="<?php echo $data['storage_id'] ?>"><?php echo $data['storage_name'] ?></option>
                                                                    <?php
                                                                            $sn++;
                                                                        }
                                                                    } else {
                                                ...
                                                <div class="col-xxl-12 col-xl-4 col-lg-4 col-md-5 mt-4">
                                                    <div class="widget-content widget-content-area ecommerce-create-section">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <button class="btn btn-primary w-100" type="submit" name="stock-add">Materyal Ekle</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
