...
<head>
    ...
    <title> Düzenleme | Asperula Kafe - Sipariş Sistemi Paneli </title>
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active">
                        <a href="#settings" data-bs-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                                <svg width="64px" height="64px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        ...
                        <ul class="collapse submenu list-unstyled show" id="settings" data-bs-parent="#accordionExample">
                            <li class="active">
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Ödeme Şekli Düzenleme</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-12">
                            <div class="alert alert-arrow-right alert-icon-right alert-light-danger alert-dismissible fade show mb-4" role="alert">
                                ...
                                <strong>Dikkat: </strong> Ödeme şekillerini düzenlerken her bir seçeneğin güncel ve doğru bilgilerle güncellendiğinden emin olun. Eksik veya hatalı bilgiler, ödeme süreçlerinde aksamalara ve müşteri memnuniyetsizliğine yol açabilir. </a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Ödeme Seçeneklerinin Güncellenmesi</h5>
                                    <p class="card-text">Ödeme seçeneklerinin düzenli olarak güncellenmesi, kafe işletmenizin modern ve kullanıcı dostu olmasını sağlar. Müşterilere daha iyi hizmet sunmak için en yeni ve popüler ödeme yöntemlerini sisteme dahil etmek büyük önem taşır.</p>
                                </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6  mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Ödeme Şekillerini Düzenlerken Nelere Dikkat Etmeli?</h5>
                                    <p class="card-text">Ödeme şekillerini düzenlerken, her ödeme yönteminin doğru kategoriye yerleştirildiğinden ve eksiksiz bilgilerle güncellendiğinden emin olun. Ödeme türü, işlem ücretleri, tedarikçi bilgileri ve geçerlilik süresi gibi bilgilerin doğruluğunu kontrol etmek, ödeme süreçlerinin işlemesini sağlar. </p>
                                </div>
                                <div class="card-footer px-4 pt-0 border-0">
                                    <a href="pages-faq.php" target="_blank">Sıkça Sorulan Sorular</a>
                                </div>
                        ...
                        <form action="app-payment-types-edit.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="widget-content widget-content-area ecommerce-create-section">
                                                <div class="row mb-4">
                                                    <div class="col-sm-12 mb-4">
                                                        <label for="payment_types_name">Ödeme Şekli Adı</label>
                                                        <input type="text" class="form-control" id="payment_types_name" name="payment_types_name" value="<?php echo $fetchDataPaymentTypesDetails['payment_types_name'] ?>">
                                                        <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $fetchDataPaymentTypesDetails['id'] ?>">
                                                    </div>
                                                    <div class="col-xxl-12 mb-4">
                                                        <div class="switch form-switch-custom switch-inline form-switch-secondary">
                                                            <input class="switch-input" type="checkbox" role="switch" name="payment_types_publicy" id="payment_types_publicy" <?php echo ($fetchDataPaymentTypesDetails['payment_types_publicy'] == '1') ? 'checked' : ''; ?>>
                                                            <label class="switch-label" for="payment_types_publicy">Ödeme Şekli Durumu</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <button class="btn btn-primary w-100" type="submit" name="payment-types-update">Ödeme Şekli Düzenleme</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
