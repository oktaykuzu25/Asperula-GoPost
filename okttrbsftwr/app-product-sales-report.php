...
<head>
    ...
    <title>Ürün Satış Raporu | Asperula Kafe - Sipariş Sistemi Paneli </title>
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Ürün Satış Raporu</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                            <div class="widget-content widget-content-area br-8">
                                <div class="container">
                                    <form action="app-product-sales-report.php" method="POST">
...
if (empty($data['day_endoftheday'])) {
    ...
    echo $data['day_endoftheday'];
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                            <div class="widget-content widget-content-area br-8">
                                <div class="container">
                                    <h1 class="text-center mt-3">Ürün Kategori Satışları
                                    </h1>
                                    <div class="table-responsive">
                                        <table class="excel-table table table-striped table-bordered">
                                            ...
                                            <?php
                                            $totalOrders = 0;
                                            if (is_array($fetchDataOrderItemsForProductCategorySales)) {
                                                foreach ($fetchDataOrderItemsForProductCategorySales as $dataOrderItems) {
                                                    $totalOrders += $dataOrderItems['total_orders'];
                                                }
                                            }
                                            ?>
                                            ...
                                            <tbody>
                                                ...
                                                if (is_array($fetchDataOrderItemsForProductCategorySales)) {
                                                    ...
                                                    foreach ($fetchDataOrderItemsForProductCategorySales as $dataOrderItems) {
                                                        $categoryId = $dataOrderItems['product_category_id'];
                                                        $fetchDataCategoryForProductCategorySales = fetch_data_category_for_product_category_sales($db, $tableNameCategory, $columnsCategory, $categoryId);

                                                        $totalPrice = $dataOrderItems['total_price'];
                                                        $totalOrdersCategory = $dataOrderItems['total_orders'];
                                                        $percentageOrders = ($totalOrdersCategory / $totalOrders) * 100;

                                                        $totalOrderPrice += $totalPrice;
                                                ?>
                                                        <tr>
                                                            <td><?php echo $fetchDataCategoryForProductCategorySales['product_category_name'] ?></td>
                                                            <td><?php echo number_format($percentageOrders, 2) ?>%</td>
                                                            <td><?php echo $totalOrdersCategory ?></td>
                                                ...
                                                <tr>
                                                    <td style="font-weight: bold;" colspan="3">Toplam Tutar</td>
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                            <div class="widget-content widget-content-area br-8">
                                <div class="container">
                                    <h1 class="text-center mt-3">Ürün Satışları
                                    </h1>
                                    <div class="table-responsive">
                                        <table class="excel-table table table-striped table-bordered">
                                            <thead>
                                            ...
                                            <?php
                                            $totalOrders = 0;
                                            if (is_array($fetchDataOrderItemsForProductSales)) {
                                                foreach ($fetchDataOrderItemsForProductSales as $dataOrderItems) {
                                                    $totalOrders += $dataOrderItems['total_orders'];
                                                }
                                            }
                                            ?>
                                            ...
                                            <tbody>
                                                ...
                                                if (is_array($fetchDataOrderItemsForProductSales)) {
                                                    ...
                                                    foreach ($fetchDataOrderItemsForProductSales as $dataOrderItems) {
                                                        ...
                                                        $totalPrice = $dataOrderItems['total_price'];
                                                        $totalOrdersProductName = $dataOrderItems['total_orders'];
                                                        $percentageOrders = ($totalOrdersProductName / $totalOrders) * 100;
                                                        $totalOrderPrice += $totalPrice;
                                                ?>
                                                        <tr>
                                                            <td><?php echo $dataOrderItems['product_name'] ?></td>
                                                            <td><?php echo number_format($percentageOrders, 2) ?>%</td>
                                                            <td><?php echo $totalOrdersProductName ?></td>
                                                            <td>₺<?php echo number_format($totalPrice, 2); ?></td>
                                                        </tr>
                                                <?php
                                                        $sn++;
