...
<head>
    ...
    <title>Sepet | Asperula Kafe - Sipariş Sistemi Paneli </title>
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class="main-wrapper">
                        ...
                        <div class="cart-main-area pt-50 pb-120">
                            <div class="container">
                                <h3 class="cart-page-title">Sepet</h3>
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                        <form method="post" action="app-cart.php">
                                                ...
                                                <table>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    <td class="product-thumbnail">
                                                                        <a href="#"><img class="ml-20" style="height: 98px;width:150px;" src="../<?php echo $item['product_image']; ?>" alt=""></a>
                                                                    </td>
                                                                    <td class="product-name"><?php echo $item['product_name']; ?></td>
                                                                    <td class="product-name"><?php echo $item['product_size']; ?></td>
                                                                    <td class="product-price-cart"><span class="amount">₺<?php echo number_format($productPrice, 2); ?></span></td>
                                                                    <td class="product-quantity pro-details-quality">
                                                                        <span class="amount">1</span>

                                                                    </td>
                                                                    <td class="product-remove">
                                                                        <a href="?remove_product_id=<?php echo $item['cart_id']; ?>"><svg width="16px" height="16px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                                                <g id="SVGRepo_iconCarrier">
                                                        ...
                                                        <?php }
                                                            ...
                                                            echo '<tr><td colspan="4">Cart Empty!</td></tr>';
                                                        }
                                                        ?>
                                                    </tbody>
                                                </table>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="discount-code-wrapper">
                                                    <div class="title-wrap">
                                                        <h4 class="cart-bottom-title section-bg-gray">İndirim Oranı </h4>
                                                    </div>
                                                    <div class="discount-code">
                                                        <p>Lütfen aşağıya indirim oranını giriniz. Sistem otomatik olarak bu oranı uygulayacaktır.</p>
                                                        <form method="post" action="app-cart.php">
                                                            <input type="text" required="" name="discount">
                                                            <button class="cart-btn-2" type="submit" name="discount-add">İndirim Oranı Ekle</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            if (empty($_SESSION['cart'])) {
                                                // $_SESSION['cart'] boş ise buradaki HTML kodu görünmez olacak
                                            ?>
                                                <!-- Bu kısım, cart boşken görünmeyecek -->
                                            <?php
                                            } else {
                                                // $_SESSION['cart'] dolu ise buradaki HTML kodu görünecek
                                            ?>
                                                <div class="col-lg-4 col-md-12">
                                                    <div class="grand-totall">
                                                        <div class="title-wrap">
                                                            <h4 class="cart-bottom-title section-bg-gary-cart">Sepet Toplamı</h4>
                                                        </div>
                                                        <div class="total-shipping2">
                                                            <h5 style="color: #ff2f2f;">Ürünler</h5>
                                                            <ul>
                                                                <?php
                                                                if (isset($_SESSION['cart']) && is_array($_SESSION['cart']) && !empty($_SESSION['cart'])) {
                                                                    $cart = $_SESSION['cart'];
                                                        ...
                                                        <h5 class="grand-totall-title">Genel Toplam <span>₺<?php echo number_format($totalPrice, 2); ?></span></h5>
                                                        <?php if (isset($discountedPrice) && $discountedPrice !== '') : ?>
                                                            <h4 class="grand-totall-title">İndirimli Fiyat <span>₺<?php echo number_format($discountedPrice, 2); ?></span></h4>
                                                        <?php endif; ?>
