...
<head>
    ...
    <title><?php echo ($fetchDataCustomersDetails['customers_name'] . " " . $fetchDataCustomersDetails['customers_surname']) ?> Stok Düzenleme | Asperula Kafe - Sipariş Sistemi Paneli </title>
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active">
                        <a href="#entities" data-bs-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                                <svg width="64px" height="64px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        ...
                        <ul class="collapse submenu list-unstyled show" id="entities" data-bs-parent="#accordionExample">
                            <li class="active">
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-12">
                            <div class="alert alert-arrow-right alert-icon-right alert-light-danger alert-dismissible fade show mb-4" role="alert">
                                ...
                                <strong>Dikkat: </strong> Müşteri bilgilerini düzenlerken her bir detayın güncel ve doğru olduğundan emin olun. Eksik veya hatalı bilgiler, müşteri ilişkileri yönetiminde karışıklıklara yol açabilir ve hizmet kalitesini düşürebilir.</a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Müşteri Bilgilerinin Güncellenmesi</h5>
                                    <p class="card-text">Müşteri bilgilerinin düzenli olarak güncellenmesi, kafe işletmenizin müşteri memnuniyetini ve sadakatini artırmak için önemlidir. Doğru ve güncel bilgiler, müşteri taleplerine hızlı ve etkili bir şekilde yanıt vermenizi sağlar.</p>
                                </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6  mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Müşteri Bilgilerini Düzenlerken Nelere Dikkat Edilmeli?</h5>
                                    <p class="card-text">Müşteri bilgilerini düzenlerken, tüm bilgilerin doğru ve güncel olduğundan emin olun. İletişim bilgileri, adres değişiklikleri ve müşteri tercihleri gibi detayları düzenli olarak kontrol edin ve güncelleyin. </p>
                                </div>
                                <div class="card-footer px-4 pt-0 border-0">
                                    <a href="pages-faq.php" target="_blank">Sıkça Sorulan Sorular</a>
                                </div>
                        ...
                        <form action="app-customers-edit.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            <div class="widget-content widget-content-area ecommerce-create-section">
                                                <div class="col-sm-12">
                                                    <div class="row mb-4">
                                                        <div class="col-sm-6">
                                                            <label for="customers_name">Müşteri Ad</label>
                                                            <input type="text" class="form-control" id="customers_name" name="customers_name" value="<?php echo $fetchDataCustomersDetails['customers_name'] ?>">
                                                            <input type="hidden" class="form-control" id="customers_id" name="customers_id" value="<?php echo $fetchDataCustomersDetails['customers_id'] ?>">
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <label for="customers_surname">Müşteri Soyad</label>
                                                            <input type="text" class="form-control" id="customers_surname" name="customers_surname" value="<?php echo $fetchDataCustomersDetails['customers_surname'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-sm-6">
                                                            <label for="customers_phone">Müşteri Telefonu</label>
                                                            <input type="text" class="form-control" id="customers_phone" name="customers_phone" value="<?php echo $fetchDataCustomersDetails['customers_phone'] ?>">
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <label for="customers_email">Müşteri Email</label>
                                                            <input type="email" class="form-control" id="customers_email" name="customers_email" value="<?php echo $fetchDataCustomersDetails['customers_email'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-sm-12">
                                                            <label for="customers_address">Müşteri Adresi</label>
                                                            <input type="text" class="form-control" id="customers_address" name="customers_address" value="<?php echo $fetchDataCustomersDetails['customers_address'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-sm-12">
                                                            <label for="customers_note">Müşteri Notu</label>
                                                            <textarea name="customers_note" class="form-control" id="customers_note" cols="30" rows="5"><?php echo $fetchDataCustomersDetails['customers_note'] ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xxl-12">
                                                                <div class="switch form-switch-custom switch-inline form-switch-secondary">
                                                                    <input class="switch-input" type="checkbox" role="switch" name="customers_publicy" id="customers_publicy" <?php echo ($fetchDataCustomersDetails['customers_publicy'] == '1') ? 'checked' : ''; ?>>
                                                                    <label class="switch-label" for="customers_publicy">Müşteri Durumu</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-xxl-12 col-xl-4 col-lg-4 col-md-5 mt-4">
                                                    <div class="widget-content widget-content-area ecommerce-create-section">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <button class="btn btn-primary w-100" type="submit" name="customers-update">Müşteri Düzenle</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
