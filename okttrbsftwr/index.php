...
<body class="alt-menu layout-boxed">
    ...
    <div class="main-container sidebar-closed sbar-open" id="container">
        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                <div class="middle-content container-xxl p-0">
                    <div class="row layout-top-spacing">
                                                            ...
                                                            <div class="your-order-info-wrap">
                                                                ...
                                                                <div class="your-order-middle">
                                                                    <ul>
                                                                        ...
                                                                        ?>
                                                                                <li>
                                                                                    <a href="?remove_product_id=<?php echo $item['cart_id']; ?>">
                                                                                        <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                                                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                                                            <g id="SVGRepo_iconCarrier">
                                                                                    ...
                                                                                    <?php echo $item['product_name']; ?> X 1
                                                                                    <span>₺<?php echo number_format($productPrice, 2); ?> <span style="font-size: 10px; margin-left:5px; color: #fa5832;"><?php echo $item['product_size']; ?></span></span>
                                                                                </li>
                                                                ...
                                                                <div class="your-order-info order-subtotal">
                                                                    <ul>
                                                                        ...
                                                                        <li>
                                                                            <div class="btn-group col-12 mt-2" role="group" aria-label="Basic example">
                                                                                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#inputFormModal">Iskonto</button>
                                                                ...
                                                                <div class="your-order-info order-total">
                                                                    <ul>
                                                                        <li class="mb-3">Total Fiyat<span>
                                                                                <?php if (isset($discountedPrice) && $discountedPrice !== '') : ?>
                                                                                    <del>₺<?php echo number_format($totalPrice, 2); ?></del>
                                                                                    <span style="font-size: 20px;"> &nbsp ₺<?php echo number_format($discountedPrice, 2); ?></span>
                                                                                <?php else : ?>
                                                                    ...
                                                                    <ul>
                                                                        <li>
                                                                            <form method="POST" action="index.php">
                                                                                <div class="btn-group-vertical mb-2 col-lg-12" role="group" aria-label="Vertical radio toggle button group">
                                                                                    <?php
                                                                                    if (is_array($fetchDataPaymentTypes)) {
                                                                                        $sn = 1;
                                                                                        foreach ($fetchDataPaymentTypes as $data) {
                                                                                    ?>
                                                                                            <input type="radio" class="btn-check" name="payment_types_name" id="<?php echo $data['payment_types_name'] ?>" value="<?php echo $data['id'] ?>" autocomplete="off">
                                                                                            <label class="btn btn-outline-primary" for="<?php echo $data['payment_types_name'] ?>"><?php echo $data['payment_types_name'] ?></label>
                                                                                    <?php
                                                                                            $sn++;
                                                                                        }
                                                                                    } else {
                                                                                        echo $fetchDataPaymentTypes;
                                                                                    } ?>
                                                                                </div>
                                                                                ...
                                                                                ?>
                                                                                    ...
                                                                                    <input type="hidden" name="products[<?php echo $index; ?>][product_size]" value="<?php echo htmlspecialchars($item['product_size']); ?>">
                                                                                    <input type="hidden" name="products[<?php echo $index; ?>][product_price]" value="<?php echo htmlspecialchars($item['product_price']); ?>">
                                                                                ...
                                                                                <?php } ?>
                                                                                <div class="btn-group col-lg-12 mt-2" role="group" aria-label="Basic example">
                                                                                    <button type="submit" class="btn btn-primary" name="order-self-close">Kaydet</button>
                                                                                    <button type="submit" class="btn btn-primary" name="order-self">Onayla</button>
                                                                                    <button type="submit" class="btn btn-primary" name="clear-cart">Kapat</button>
                                                                                </div>
                                                                            </form>
                        ...
                        <div class="row col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">

                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-6 layout-spacing">
                                <div class="account-content scrollable">
                                    <ul class="nav nav-pills flex-column" id="animateLine" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active d-flex justify-content-center align-items-center text-center" id="animated-all-tab" data-bs-toggle="tab" href="#animated-all" role="tab" aria-controls="animated-all" aria-selected="true" style="width: 100%; height: 100%;">
                                                <span>Hepsi</span>
                                            </button>
                                        ...
                                        ?>
                                                <li class="nav-item" role="presentation">
                                                    <button class="mt-3 nav-link" id="animated-<?php echo cleanTurkishCharacters($data['product_category_id']) ?>-tab" data-bs-toggle="tab" href="#animated-<?php echo cleanTurkishCharacters($data['product_category_id']) ?>" role="tab" aria-controls="animated-<?php echo cleanTurkishCharacters($data['product_category_id']) ?>" aria-selected="false" style="width: 100%; height: 100%;"><?php echo $data['product_category_name'] ?></button>
                                                </li>
                                        <?php
                                                $sn++;
                                            }
                            ...
                            <div class="col-xl-9 col-lg-9 col-md-9 col-sm-6 col-6 layout-spacing">
                                <div class="tab-content" id="animateLineContent-4">
                                    <div class="tab-pane fade show active scrollable" id="animated-all" role="tabpanel" aria-labelledby="animated-all-tab">
                                        <div class="row">
                                            ...
                                            ?>
                                                    <div class="col-xl-4 col-lg-6 col-md-12 layout-spacing">
                                                        <div class="section general-info border app-menu-product-section" style="background-image: url(../<?php echo $data['product_image']; ?>); background-size: cover;">
                                                            <div class="info">
                                                                <h6 class="text-white"><?php echo $data['product_name']; ?></h6>
                                                                <div class="dropdown">
                                                                    <a class="dropdown-toggle d-flex justify-content-center" href="#" role="button" id="dropdownMenuLink-1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right left" aria-labelledby="dropdownMenuLink-1">
                                                                        <?php if (!empty($data['product_small_price'])) : ?>
                                                                            <form method="post" action="app-cart.php?addCart=<?php echo $data['product_small_price']; ?>">
                                                                                ...
                                                                                <button type="submit" class="dropdown-item "><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus">
                                                                                        <line x1="12" y1="5" x2="12" y2="19"></line>
                                                                                        <line x1="5" y1="12" x2="19" y2="12"></line>
                                                                                    </svg>
                                                                                    ₺<?php echo number_format($data['product_small_price'], 2); ?> <span style="color: #fa5832;">Küçük</span>
                                                                                </button>
                                                                            </form>
                                                                        <?php endif; ?>
                                                                            ...
                                                                            <form method="post" action="app-cart.php?addCart=<?php echo $data['product_middle_price']; ?>">
                                                                                ...
                                                                                <button type="submit" class="dropdown-item">
                                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus">
                                                                                        <line x1="12" y1="5" x2="12" y2="19"></line>
                                                                                        <line x1="5" y1="12" x2="19" y2="12"></line>
                                                                                    </svg> ₺<?php echo number_format($data['product_middle_price'], 2); ?> <span style="color: #fa5832;">Orta</span>
                                                                                </button>
                                                                            </form>
                                                                        <?php endif; ?>
                                                                            ...
                                                                            <form method="post" action="app-cart.php?addCart=<?php echo $data['product_big_price']; ?>">
                                                                                ...
                                                                                <button type="submit" class="dropdown-item">
                                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus">
                                                                                        <line x1="12" y1="5" x2="12" y2="19"></line>
                                                                                        <line x1="5" y1="12" x2="19" y2="12"></line>
                                                                                    </svg>₺<?php echo number_format($data['product_big_price'], 2); ?> <span style="color: #fa5832;">Büyük</span>
                                                                                </button>
                                                                            </form>
                                                                        <?php endif; ?>
                                                                            ...
                                                                            <form method="post" action="app-cart.php?addCart=<?php echo $data['product_normal_price']; ?>">
                                                                                ...
                                                                                <button type="submit" class="dropdown-item">
                                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus">
                                                                                        <line x1="12" y1="5" x2="12" y2="19"></line>
                                                                                        <line x1="5" y1="12" x2="19" y2="12"></line>
                                                                                    </svg>₺<?php echo number_format($data['product_normal_price'], 2); ?> <span style="color: #fa5832;">Normal</span>
                                                                                </button>
                                                                            </form>
                                                                        <?php endif; ?>
                                                                    </div>
                                                                    ...
                                                                    <div class="section general-info border app-menu-product-section" style="background-image: url(../<?php echo $data['product_image']; ?>); background-size: cover;">
                                                                        <div class="info">
                                                                            ...
                                                                            <div class="dropdown">
                                                                                ...
                                                                                <div class="dropdown-menu dropdown-menu-right left" aria-labelledby="dropdownMenuLink-<?php echo $data['product_id']; ?>">
                                                                                    <?php if (!empty($data['product_small_price'])) : ?>
                                                                                        <form method="post" action="app-cart.php?addCart=<?php echo $data['product_small_price']; ?>">
                                                                                            <input type="hidden" name="product_size" value="Küçük">
                                                                                            <input type="hidden" name="product_id" value="<?php echo $data['product_id'] ?>">
                                                                                            ...
                                                                                            <button type="submit" class="dropdown-item ">
                                                                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus">
                                                                                                    <line x1="12" y1="5" x2="12" y2="19"></line>
                                                                                                    <line x1="5" y1="12" x2="19" y2="12"></line>
                                                                                                </svg>₺<?php echo number_format($data['product_small_price'], 2); ?> <span style="color: #fa5832;">Küçük</span>
                                                                                            </button>
                                                                                        </form>
                                                                                    <?php endif; ?>
            ...
            <!-- Modal -->
            <div class="modal fade inputForm-modal col-md-4 col-4" id="inputFormModal" tabindex="-1" role="dialog" aria-labelledby="inputFormModalLabel" aria-hidden="true">
                <div class=" modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header" id="inputFormModalLabel">
                            <h5 class="modal-title">İskonto<b> İndirim Yüzdesi</b></h5>
                        ...
                        <div class="modal-body">
                            <form class="mt-0" method="post" action="index.php">
    ...
    <script src="../src/assets/js/cart/cart.js"></script>
