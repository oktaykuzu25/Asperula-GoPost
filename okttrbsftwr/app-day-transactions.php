...
<head>
    ...
    <title>Gün işlemleri | Asperula Kafe - Sipariş Sistemi Paneli </title>
...
<body class="layout-boxed">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    ?>
                        ...
                        <li class="menu active">
                            <a href="./app-day-transactions.php" aria-expanded="true" class="dropdown-toggle">
                                <div class="">
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class="row" id="cancel-row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12 ">
                            <form id="dayTransactionsForm" action="app-day-transactions.php" method="POST">
                                <div class="row mt-4">
                                    <div class="col-sm-4">
                                        <button id="perdayButton" class="btn btn-success w-100" type="submit" name="perday">Gün Başı Yap</button>
                                    </div>
                                    <div class="col-sm-4">
                                        <button id="endofdayButton" class="btn btn-danger w-100" type="submit" name="endofday">Gün Sonu Yap</button>
                                    </div>
                                    <div class="col-sm-4">
                                        <button class="btn btn-primary w-100" type="submit" name="addmoney">Kasaya Para Ekle</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-sm-12 layout-top-spacing layout-spacing">
                            <div class="widget-content widget-content-area br-8">
                                <table id="invoice-list" class="table dt-table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                        if (is_array($fetchDataDayTypes)) {
                                            $sn = 1;
                                            foreach ($fetchDataDayTypes as $data) {
                                                $product_category_name_url = $data['day_perday'];
                                                $product_category_id_url = $data['day_id'];
                                        ...
                                        ?>
                                                ...
                                                <tr>
                                                    <td class="checkbox-column"> <?php echo $data['day_perday'] ?> </td>
                                                    <td><span class="inv-amount"> <?php echo $data['day_endoftheday'] ?></span></td>
                                                    <td>
                                                        <div class="d-flex">
                                                    ...
                                                    <td><span class="inv-amount"></span> </td>
    ...
    <script src="../src/assets/js/apps/app-day-transactions.js"></script>
