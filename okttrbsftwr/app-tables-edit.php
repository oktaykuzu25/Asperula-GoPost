...
<head>
    ...
    <title>Asperula Kafe -Masa Güncelleme </title>
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Masalar</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Masa Ekleme </li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <form action="app-buniesses-ad.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-4 layout-spacing layout-top-spacing">
                                        ...
                                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div class="widget-content widget-content-area ecommerce-create-section">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-sm-6">
                                                        <label for="product_name">Masa Numarası </label>
                                                        <input type="text" class="form-control" name="tables_number" value="<?php echo $fetchDataApptablesUpdate['tables_number'] ?>">
                                                        <input type="hidden" class="form-control" name="tables_id" value="<?php echo $fetchDataApptablesUpdate['tables_id'] ?>">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label for="product_name">Masa Adı </label>
                                                        <input type="text" class="form-control" name="tables_name" value="<?php echo $fetchDataApptablesUpdate['tables_name'] ?>">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-12 col-md-6 mb-4">
                                                    <label for="product_category_id"> Masa Konumu</label>
                                                    <select class="form-select" id="product_category_id" name="tables_role" value="<?php echo $fetchDataApptablesUpdate['tables_role'] ?>">
                                                        <option value="Kafe_ici">Kafe içi </option>
                                                        <option value="kafe_bahce">Kafe Bahçe </option>
                                                    </select>
                                                </div>


                                                <div class="col-sm-12">
                                                    <button class="btn btn-primary w-100" type="submit" name="App-tables-update">Masa Güncelle</button>
                                                </div>
