...
<head>
    ...
    <title>Müşteri Ekle | Asperula Kafe - Sipariş Sistemi Paneli </title>
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="app-customers.php">Varlıklar</a></li>
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-12">
                            <div class="alert alert-arrow-right alert-icon-right alert-light-danger alert-dismissible fade show mb-4" role="alert">
                                ...
                                <strong>Dikkat: </strong> Müşteri bilgilerini eklerken her bir detayın doğru ve eksiksiz girildiğinden emin olun. Yanlış veya eksik bilgiler, müşteri ilişkileri yönetiminde aksamalara neden olabilir ve hizmet kalitesini olumsuz etkileyebilir. </a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Müşteri Bilgilerinin Önemi</h5>
                                    <p class="card-text">Müşteri bilgileri, kafe işletmenizin müşteri ilişkileri yönetimini geliştirmek ve kişiselleştirilmiş hizmet sunmak için kritik bir rol oynar. Doğru ve güncel müşteri bilgileri, sadık müşteri tabanı oluşturmanızı ve pazarlama stratejilerinizi etkili bir şekilde uygulamanızı sağlar.</p>
                                </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6  mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    <h5 class="card-title mb-3">Müşteri Bilgileri Eklerken Nelere Dikkat Edilmeli?</h5>
                                    <p class="card-text">Müşteri bilgileri eklerken, ad, soyad, iletişim bilgileri, doğum tarihi ve tercihleri gibi bilgilerin eksiksiz ve doğru olduğundan emin olun. Ayrıca, müşteri gizliliğine dikkat ederek bilgileri güvenli bir şekilde saklayın. Bu bilgiler, müşterilere daha iyi hizmet sunmanızı sağlar.</p>
                                </div>
                                <div class="card-footer px-4 pt-0 border-0">
                                    <a href="pages-faq.php" target="_blank">Sıkça Sorulan Sorular</a>
                                </div>
                        ...
                        <form action="app-customers-add.php" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <input type="text" class="form-control" id="customers_surname" name="customers_surname">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-sm-6">
                                                            <label for="customers_phone">Müşteri Telefonu</label>
                                                            <input type="text" class="form-control" id="customers_phone" name="customers_phone">
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <label for="customers_email">Müşteri Email</label>
                                                            <input type="email" class="form-control" id="customers_email" name="customers_email">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-sm-12">
                                                            <label for="customers_address">Müşteri Adresi</label>
                                                            <input type="text" class="form-control" id="customers_address" name="customers_address">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-sm-12">
                                                            <label for="customers_note">Müşteri Notu</label>
                                                            <textarea name="customers_note" class="form-control" id="customers_note" cols="30" rows="5"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xxl-12">
                                                                <div class="switch form-switch-custom switch-inline form-switch-secondary">
                                                                    <input class="switch-input" type="checkbox" role="switch" name="customers_publicy" id="customers_publicy">
                                                ...
                                                <div class="col-xxl-12 col-xl-4 col-lg-4 col-md-5 mt-4">
                                                    <div class="widget-content widget-content-area ecommerce-create-section">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <button class="btn btn-primary w-100" type="submit" name="customers-add">Müşteri Ekle</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
