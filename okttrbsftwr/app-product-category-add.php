...
<head>
    ...
    <title>Kategori Ekle | Asperula Kafe - Sipariş Sistemi Paneli </title>
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Kategoriler Ekle</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-12">
                            <div class="alert alert-arrow-right alert-icon-right alert-light-danger alert-dismissible fade show mb-4" role="alert">
                                ...
                                <strong>Dikkat: </strong> Kategori eklerken, kategorilerin doğru ve mantıklı bir şekilde sınıflandırıldığından emin olun. Bu, müşterilerin aradıkları ürünleri kolayca bulmalarına yardımcı olacaktır.</a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    ...
                                    <p class="card-text">Kategori isminin net ve açıklayıcı olmasına özen gösterin. Müşterilerin hangi ürünlerin bu kategori altında bulunacağını kolayca anlamaları gereklidir.
                                    </p>
                                </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6  mb-4">
                            <div class="card border">
                                <div class="card-body pt-3">
                                    ...
                                    <p class="card-text">Kategorilerin görünüm sırasını mantıklı bir şekilde belirleyin. En popüler veya en çok aranan kategorilerin üst sıralarda yer alması, müşteri deneyimini iyileştirir.
                                    </p>
                                </div>
                                <div class="card-footer px-4 pt-0 border-0">
                                    <a href="pages-faq.php" target="_blank">Sıkça Sorulan Sorular</a>
                        ...
                        <form action="app-product-category-add.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="widget-content widget-content-area ecommerce-create-section">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <textarea name="product_category_description" class="form-control" id="product_category_description" cols="30" rows="5"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xxl-12">
                                                                <div class="switch form-switch-custom switch-inline form-switch-secondary">
                                                                    <input class="switch-input" type="checkbox" role="switch" name="product_category_publicy" id="product_category_publicy">
                                                ...
                                                <div class="col-xxl-12 col-xl-4 col-lg-4 col-md-5 mt-4">
                                                    <div class="widget-content widget-content-area ecommerce-create-section">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <button class="btn btn-primary w-100" type="submit" name="category-add">Kategori Ekle</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
